...
#### [Recursively Delete .DS\_Store Files](https://git.herrbischoff.com/awesome-macos-command-line/about/#recursively-delete-ds_store-files)
...
Below are direct links or App Store links to download the respective OS versions. To download a specific installer via terminal, you can also use the `softwareupdate` utility:
...
Replace the version number with the patch level you want. If it exists, it should download and install itself into the Applications folder.
