...
If you want to contribute, you are highly encouraged to do so. Please read the [contribution guidelines](https://git.herrbischoff.com/awesome-command-line-apps/about/contributing.md).

## [Women Empowerment in Zanzibar](https://git.herrbischoff.com/awesome-command-line-apps/about/#women-empowerment-in-zanzibar)

Send a little karma down the way and support women empowerment in Zanzibar by helping to [fund the local production of reusable female hygiene products](https://www.gofundme.com/f/women-empowerment-in-zanzibar). A very dear friend of mine runs the project. They were already able to buy hundreds of educational books. Sometimes, it takes so little to make a huge impact. If you'd like to thank me or support this work, donate. Additionally, any current and future sponsoring of my work via GitHub or other channels will flow one hundred percent to the NGO.
...
-   [\*nix/\*nux](https://git.herrbischoff.com/awesome-command-line-apps/about/#nixnux)
    -   [Automation](https://git.herrbischoff.com/awesome-command-line-apps/about/#automation)
    -   [Backup](https://git.herrbischoff.com/awesome-command-line-apps/about/#backup)
    -   [Benchmarking](https://git.herrbischoff.com/awesome-command-line-apps/about/#benchmarking)
    -   [Cloud Services](https://git.herrbischoff.com/awesome-command-line-apps/about/#cloud-services)
    -   [Compression](https://git.herrbischoff.com/awesome-command-line-apps/about/#compression)
    -   [Content Creation](https://git.herrbischoff.com/awesome-command-line-apps/about/#content-creation)
    -   [Conversion](https://git.herrbischoff.com/awesome-command-line-apps/about/#conversion)
    -   [Data Processing](https://git.herrbischoff.com/awesome-command-line-apps/about/#data-processing)
    -   [Databases](https://git.herrbischoff.com/awesome-command-line-apps/about/#databases)
    -   [Developer](https://git.herrbischoff.com/awesome-command-line-apps/about/#developer)
    -   [Dotfile Management](https://git.herrbischoff.com/awesome-command-line-apps/about/#dotfile-management)
    -   [Download Utilities](https://git.herrbischoff.com/awesome-command-line-apps/about/#download-utilities)
    -   [Email](https://git.herrbischoff.com/awesome-command-line-apps/about/#email)
    -   [Encryption](https://git.herrbischoff.com/awesome-command-line-apps/about/#encryption)
    -   [Filesystem Management](https://git.herrbischoff.com/awesome-command-line-apps/about/#filesystem-management)
    -   [FTP](https://git.herrbischoff.com/awesome-command-line-apps/about/#ftp)
    -   [Games](https://git.herrbischoff.com/awesome-command-line-apps/about/#games)
    -   [IRC](https://git.herrbischoff.com/awesome-command-line-apps/about/#irc)
    -   [Media](https://git.herrbischoff.com/awesome-command-line-apps/about/#media)
    -   [Miscellaneous](https://git.herrbischoff.com/awesome-command-line-apps/about/#miscellaneous)
    -   [Networking](https://git.herrbischoff.com/awesome-command-line-apps/about/#networking)
    -   [Presentation](https://git.herrbischoff.com/awesome-command-line-apps/about/#presentation)
    -   [Productivity](https://git.herrbischoff.com/awesome-command-line-apps/about/#productivity)
    -   [RSS](https://git.herrbischoff.com/awesome-command-line-apps/about/#rss)
    -   [Searching](https://git.herrbischoff.com/awesome-command-line-apps/about/#searching)
    -   [Security](https://git.herrbischoff.com/awesome-command-line-apps/about/#security)
    -   [Shells](https://git.herrbischoff.com/awesome-command-line-apps/about/#shells)
    -   [SSH](https://git.herrbischoff.com/awesome-command-line-apps/about/#ssh)
    -   [System](https://git.herrbischoff.com/awesome-command-line-apps/about/#system)
    -   [Terminal](https://git.herrbischoff.com/awesome-command-line-apps/about/#terminal)
    -   [Text Editors](https://git.herrbischoff.com/awesome-command-line-apps/about/#text-editors)
    -   [Version Control](https://git.herrbischoff.com/awesome-command-line-apps/about/#version-control)
    -   [VPN](https://git.herrbischoff.com/awesome-command-line-apps/about/#vpn)
    -   [World Wide Web](https://git.herrbischoff.com/awesome-command-line-apps/about/#world-wide-web)
-   [BSD](https://git.herrbischoff.com/awesome-command-line-apps/about/#bsd)
-   [Linux](https://git.herrbischoff.com/awesome-command-line-apps/about/#linux)
-   [macOS](https://git.herrbischoff.com/awesome-command-line-apps/about/#macos)
-   [Helpers](https://git.herrbischoff.com/awesome-command-line-apps/about/#helpers)
...
-   [rocinante](https://rocinante.sh/) - Lightweight configuration management software for FreeBSD.
...
-   [LiteCLI](https://litecli.com/) - SQLite client with auto-completion.
...
-   [hq](https://github.com/rbwinslow/hq) - Powerful command-line tool for slicing & dicing HTML.
...
-   [tq](https://github.com/plainas/tq) - Perform a lookup by CSS selector on an HTML input.
-   [xq](https://github.com/jeffbr13/xq) - Like jq, but for XML and XPath.
...
-   [diff-so-fancy](https://github.com/so-fancy/diff-so-fancy) - Better, highly readable diffs.
...
-   [http-prompt](https://github.com/eliangcs/http-prompt) - Interactive HTTP client featuring autocomplete and syntax highlighting, built on HTTPie and prompt\_toolkit.
...
-   [IMAPdedup](https://github.com/quentinsf/IMAPdedup) - IMAP message de-duplicator.
...
-   [nnn](https://github.com/jarun/nnn) - Fast, minimal and extensible file manager.
...
-   [musikcube](https://musikcube.com/) - Fully functional terminal-based music player, library, and streaming audio server.
...
-   [wttr.in](https://github.com/chubin/wttr.in) - Console-based weather forecasts.
...
-   [ipdb](https://github.com/cyclaero/ipdb) - Tools for IP based Geo-blocking and Geo-routing.
...
-   [bpytop](https://github.com/aristocratos/bpytop) - Resource monitor that shows usage and stats for processor, memory, disks, network and processes.
...
-   [angle-grinder](https://github.com/rcoh/angle-grinder) - Slice and dice logs, allows to parse, aggregate, sum, average, min/max, percentile, and sort data.
...
-   [LNAV](https://lnav.org/) - Advanced log file viewer for the small-scale that understands your log files.
...
-   [browsh](https://www.brow.sh/) - A fully interactive, real-time and modern browser rendered to TTY.
...
## [License](https://git.herrbischoff.com/awesome-command-line-apps/about/#license)
