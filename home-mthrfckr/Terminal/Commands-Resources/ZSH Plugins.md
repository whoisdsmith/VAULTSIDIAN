...
- [fzf-z](https://github.com/andrewferrier/fzf-z) - Brings together the \*zplugin and \*[fzf](https://github.com/junegunn/fzf)\- to allow you to easily browse recently used directories at any point on the command line.
...
- [sudo (hcgraf)](https://github.com/hcgraf/zsh-sudo) - The `sudo` plugin from [oh-my-zsh](https://ohmyz.sh/), extracted to a standalone. Toggles `sudo` before the current/previous command by pressing \*ESC-ESCin emacs-mode or vi-command mode.
