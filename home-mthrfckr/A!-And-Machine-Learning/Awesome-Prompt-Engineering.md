...
| :-------------------- | :----------: | :----------: |
| **GPT Index** | GPT Index is a project consisting of a set of data structures designed to make it easier to use large external knowledge bases with LLMs. | [[Ai-Mthrfckr/Development/Github.md]]ckr/Development/Github.md]](https://github.com/jerryjliu/gpt_index) |
| **Promptify** | Solve NLP Problems with LLM's & Easily generate different NLP Task prompts for popular generative models like GPT, PaLM,[[Ai-Mthrfckr/Development/Github.md]]with Promptify | [[Ai-Mthrfckr/Development/Github.md]](https://github.com/promptslab/Promptify) |
| **Better Prompt** | Tes[[Ai-Mthrfckr/Development/Github.md]]r LLM prompts before pushing them to PROD | [[Ai-Mthrfckr/Development/Github.md]](https://github.com/krrishdholakia/betterprompt) |
| **Interactive Composition Explorerx[[Ai-Mthrfckr/Development/Github.md]]s a Python library and trace visualizer for language model programs. | [[Ai-Mthrfckr/Development/Github.md]](ht[[Ai-Mthrfckr/Development/Github.md]]ub.com/oughtinc/ice) |
| **LangChainx** | Building applications with LLMs through composability | [[Ai-Mthrfc[[Ai-Mthrfckr/Development/Github.md]]ment/Github.md]](https://github.com/hwchase17/langchain) |
| **OpenPrompt** | An Open-Source Framework for Prompt-learning | [[Ai-Mthrfckr/Development/Github.md]](https://github.[[Ai-Mthrfckr/Development/Github.md]]/OpenPrompt) |
| **Prompt Engine** | This repo contains an NPM utility library for creating and maintaining prompts for Large Language Models (LLMs). | [[Ai-Mthrfckr/Development/Github.md]](https://github.com/microsoft/prompt-engine) [[Ai-Mthrfckr/Development/Github.md]]ptInject** | PromptInject is a framework that assembles prompts in a modular fashion to provide a quanti[[Ai-Mthrfckr/Development/Github.md]]lysis of the robustness of LLMs to adversarial prompt attacks. | [[Ai-Mthrfckr/Development/Github.md]](https://github.com/agencyenterprise/PromptInject) |[[Ai-Mthrfckr/Development/Github.md]]ts AI** | Advanced playground for GPT-3 | [[Ai-Mthrfckr/Development/Github.md]](https://github.com/sevazhidkov/prompts-ai) |
| *[[Ai-Mthrfckr/Development/Github.md]]urce** | PromptSource is a toolkit for creating, sharing and using natural language prompts. | [[Ai-Mthrfckr/Development/Github.md]](https://github.com/bigscience-workshop/promptsource) |
| **ThoughtSource** | A framework for the science of machine thinking | [[Ai-Mthrfckr/Development/Github.md]](https://github.com/OpenBioLink/ThoughtSource) |
...
|      Name                | Description  | Url |
| :-------------------- | :----------: | :----------: |
| **P3 (Pub[[Ai-Mthrfckr/Development/Github.md]]f Prompts)** | P3 (Public Pool of Prompts) is a collection of prompted English datasets covering a diverse set of NLP tasks. | [[Ai-Prompts/Huggingface/Huggingface.md]](https://huggingface.co/datasets/bigscience/P3) |
| **Awesome ChatGPT Prompts** | Repo includes ChatGPT prompt curation to use ChatGPT better. | [[Ai-Mthrfckr/Development/Github.md]](https://github.com/f/awesome-chatgpt-prompts) |
...
|     [[Ai-Mthrfckr/Development/Github.md]]           | Description  | Url | 
| :-------------------- | :----------: | :----------: |
| **ChatGPT** | ChatGPT  | [[OpenAI]](https://chat.openai.com/) |
| **Codex** | The Codex models are descendants of our GPT-3 models that can understand and generate code. Their training data contains both natural language and billions of lines of public code from GitHub  | [[Ai-Mthrfckr/Development/Github.md]](https://platform.openai.com/docs/models/codex) |
...
| **XLM-RoBERTa-XL** | XLM-RoBERTa-XL model pre-trained o[[Ai-Mthrfckr/Development/Github.md]] filtered CommonCrawl data containing 100 languages.  | [[Ai-Prompts/Huggingface/Huggingface.md]](https://huggingface.co/facebook/xlm-roberta-xxl) |
| **GPT-J** | It is[[Ai-Mthrfckr/Development/Github.md]]ike causal language model trained on the Pile dataset  | [[Ai-Prompts/Huggingface/Huggingface.md]](https://huggingface.co/docs/transformers/model_doc/gptj) |
| **PaLM-rlhf-p[[Ai-Mthrfckr/Development/Github.md]] Implementation of RLHF (Reinforcement Learning with Human Feedback) on top of the PaLM architecture. Basically ChatGPT but with PaLM | [[A[[Ai-Mthrfckr/Development/Github.md]]/Development/Github.md]](https://github.com/lucidrains/PaLM-rlhf-pytorch)
| **GPT-Neo** | An implementation o[[Ai-Mthrfckr/Development/Github.md]]rallel GPT-2 and GPT-3-style models using the mesh-tensorflow library. | [[Ai-Mthrfckr/Development/Github.md]](https://github.com/EleutherAI/gpt-neo) |
| **LaMDA-rlhf-pytorch** | Open-source pre-training implementation of Google's LaMDA in PyTorch. Adding RLHF similar to ChatGPT. | [[Ai-Mthrfckr/Development/Github.md]](https://github.com/conceptofmind/LaMDA-rlhf-pytorch) |
| **RLHF** | Implementation of Reinforcement Learning from Human Feedback (RLHF) | [[Ai-Mthrfckr/Development/Github.md]](https://github.com/xrsrke/instructGOOSE) |
| **GLM-130B** | GLM-130B: An Open Bilingual Pre-Trained Model | [[Ai-Mthrfckr/Development/Github.md]](https://github.com/THUDM/GLM-130B) |

## AI Content Detectors
🔎

|      Name                | Description  | Ur[[home-mthrfckr/A!-And-Machine-Learning/Ai-Mthrfckr/Development/Github]]------------------ | :----------: | :----------: |
...
| **Openai Detector** | AI classifier for indicating AI-written text (OpenAI Detector Python wrapper)  | [[Ai-Mthrfckr/Development/Github.md]](https://github.com/promptslab/openai-detector) |
