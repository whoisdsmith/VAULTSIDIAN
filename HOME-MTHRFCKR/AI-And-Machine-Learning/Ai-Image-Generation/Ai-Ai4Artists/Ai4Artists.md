...
* ⭐️ **[Deep Learning for Computer Vision (UMich)](https://web.eecs.umich.edu/~justincj/teaching/eecs498/WI2022/)**
...
* ⭐️ **[Learning-Based Image Synthesis (CMU)](https://learning-image-synthesis.github.io/sp22/)**
...
* ⭐️ **[Deep Learning for Art, Aesthetics, and Creativity (MIT)](https://ali-design.github.io/deepcreativity/)**
...
* ⭐️ **[The AI that creates any picture you want, explained (Vox)](https://youtu.be/SVcsDDABEkM)**
...
* ⭐️ **[Dive into Deep Learning (Zhang, Lipton, Li, and Smola)](https://d2l.ai/index.html)**
...
* ⭐️ **[VQGAN-CLIP: Open Domain Image Generation and Editing with Natural Language Guidance (Crowson and Biderman)](https://arxiv.org/pdf/2204.08583.pdf)**
...
* ⭐️ **[Making Generative Art with Simple Mathematics](http://www.hailpixel.com/articles/generative-art-simple-mathematics)**
...
* ⭐️ **[NeRF: Representing Scenes as Neural Radiance Fields for View Synthesis](https://arxiv.org/abs/2003.08934)**: The paper that started it all…
...
* ⭐️ **[Magic3D: High-Resolution Text-to-3D Content Creation (NVIDIA)](https://deepimagination.cc/Magic3D/)**
...
* ⭐️ **[Analyzing and Improving the Image Quality of StyleGAN (StyleGAN2)](https://arxiv.org/abs/1912.04958)**
...
* ⭐️ **[HyperStyle: StyleGAN Inversion with HyperNetworks for Real Image Editing](https://yuval-alaluf.github.io/hyperstyle/)**
...
* ⭐️ **[Discovering Interpretable GAN Controls (GANspace)](https://github.com/harskish/ganspace)**
...
* ⭐️ **[Robust Human Matting via Semantic Guidance](https://arxiv.org/pdf/2210.05210v1.pdf)**
...
* ⭐️ **[Magenta](https://magenta.tensorflow.org/)**
...
* ⭐️ **[Stable Diffusion](https://github.com/CompVis/stable-diffusion)**
...
* ⭐️ **[Stable Diffusion Web UI](https://github.com/AUTOMATIC1111/stable-diffusion-webui)**: A user friendly UI for SD with additional [features](https://github.com/AUTOMATIC1111/stable-diffusion-webui/wiki/Features) to make common workflows easy.
...
* ⭐️ **[Processing (Java)](https://processing.org/) and [p5.js (Javascript)](https://p5js.org/)**
