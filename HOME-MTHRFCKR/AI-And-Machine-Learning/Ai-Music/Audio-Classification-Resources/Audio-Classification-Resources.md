...
Please refer to the [../../../Bookmrks-Mthrfckr/Software-Tools/Contributing.md](../../../Bookmrks-Mthrfckr/Software-Tools/Contributing.md) file.
...
A list of useful acronyms use[Acronyms.md](Acronyms.md)ic is stored in [Acronyms.md](Acronyms.md).

[Go back to top](https://github.com/ybayle/awesome-deep-learning-music#deep-learning-for-music-dl4m-)

## Sources

The list of conferences, journals and aggregators used to g[Sources.md](Sources.md)ials is stored in [Sources.md](Sources.md).
