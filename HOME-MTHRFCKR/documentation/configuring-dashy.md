...
| **`appConfig`** | `object` | _Optional_ | Settings related to how the app functions, including API keys and global styles. See [`appConfig`](https://dashy.to/docs/#appconfig-optional) |
...
| **`pages`** | `array` | _Optional_ | An array additional config files, used for multi-page dashboards. See [`pages`](https://dashy.to/docs/#pages-optional) |
...
| **`navLinks`** | `array` | _Optional_ | Optional list of a maximum of 6 links, which will be displayed in the navigation bar. See [`navLinks`](https://dashy.to/docs/#pageinfonavlinks-optional) |
...
### `pageInfo.navLinks` _(optional)_[#](https://dashy.to/docs/#pageinfonavlinks-optional "Direct link to heading")
...
### `pages[]` _(optional)_[#](https://dashy.to/docs/#pages-optional "Direct link to heading")
...
### `appConfig` _(optional)_[#](https://dashy.to/docs/#appconfig-optional "Direct link to heading")
...
| **`webSearch`** | `object` | _Optional_ | Configuration options for the web search feature, set your default search engine, opening method or disable web search. See [`webSearch`](https://dashy.to/docs/#appconfigwebsearch-optional) |
...
| **`auth`** | `object` | _Optional_ | All settings relating to user authentication. See [`auth`](https://dashy.to/docs/#appconfigauth-optional) |
...
| **`hideComponents`** | `object` | _Optional_ | A list of key page components (header, footer, search, settings, etc) that are present by default, but can be removed using this option. See [`appConfig.hideComponents`](https://dashy.to/docs/#appconfighideComponents-optional) |
...
### `appConfig.auth` _(optional)_[#](https://dashy.to/docs/#appconfigauth-optional "Direct link to heading")

| **Field** | **Type** | **Required** | **Description** |
| --- | --- | --- | --- |
| **`users`** | `array` | _Optional_ | An array of objects containing usernames and hashed passwords. If this is not provided, then authentication will be off by default, and you will not need any credentials to access the app. See [`appConfig.auth.users`](https://dashy.to/docs/#appconfigauthusers-optional).  
...
| **`keycloak`** | `object` | _Optional_ | Config options to point Dashy to your Keycloak server. Requires `enableKeycloak: true`. See [`auth.keycloak`](https://dashy.to/docs/#appconfigauthkeycloak-optional) for more info |
...
### `appConfig.auth.users` _(optional)_[#](https://dashy.to/docs/#appconfigauthusers-optional "Direct link to heading")
...
### `appConfig.auth.keycloak` _(optional)_[#](https://dashy.to/docs/#appconfigauthkeycloak-optional "Direct link to heading")
...
### `appConfig.webSearch` _(optional)_[#](https://dashy.to/docs/#appconfigwebsearch-optional "Direct link to heading")
...
### `appConfig.hideComponents` _(optional)_[#](https://dashy.to/docs/#appconfighidecomponents-optional "Direct link to heading")
...
| **`icon`** | `string` | _Optional_ | An single icon to be displayed next to the title. See [`section.icon`](https://dashy.to/docs/#sectionicon-and-sectionitemicon) |
| **`items`** | `array` | _Optional_ | An array of items to be displayed within the section. See [`item`](https://dashy.to/docs/#sectionitem). Sections must include either 1 or more items, or 1 or more widgets. |
| **`widgets`** | `array` | _Optional_ | An array of widgets to be displayed within the section. See [`widget`](https://dashy.to/docs/#sectionwidget-optional) |
| **`displayData`** | `object` | _Optional_ | Meta-data to optionally overide display settings for a given section. See [`displayData`](https://dashy.to/docs/#sectiondisplaydata-optional) |
...
| **`icon`** | `string` | _Optional_ | The icon for a given item. Can be a font-awesome icon, favicon, remote URL or local URL. See [`item.icon`](https://dashy.to/docs/#sectionicon-and-sectionitemicon) |
...
| **`displayData`** | `object` | _Optional_ | Meta-data to optionally overide display settings for a given item. See [`displayData`](https://dashy.to/docs/#itemdisplaydata-optional) |

**[⬆️ Back to Top](https://dashy.to/docs/#)**

### `item.displayData` _(optional)_[#](https://dashy.to/docs/#itemdisplaydata-optional "Direct link to heading")
...
### `section.widget` _(optional)_[#](https://dashy.to/docs/#sectionwidget-optional "Direct link to heading")

| **Field** | **Type** | **Required** | **Description** |
| --- | --- | --- | --- |
| **`type`** | `string` | Required | The widget type. See [Widget Docs](https://dashy.to/docs/widgets) for full list of supported widgets |
| **`options`** | `object` | _Optional_ | Some widgets accept either optional or required additional options. Again, see the [Widget Docs](https://dashy.to/docs/widgets) for full list of options |
| **`updateInterval`** | `number` | _Optional_ | You can keep a widget constantly updated by specifying an update interval, in seconds. See [Continuous Updates Docs](https://dashy.to/docs/widgets#continuous-updates) for more info |
...
### `section.displayData` _(optional)_[#](https://dashy.to/docs/#sectiondisplaydata-optional "Direct link to heading")
