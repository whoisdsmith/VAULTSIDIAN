---
created: 2022-08-09T17:02:50 (UTC -04:00)
tags: []
...
### Using Local Sub-Pages[#](https://dashy.to/docs/#using-local-sub-pages "Direct link to heading")
...
### Using Remote Sub-Pages[#](https://dashy.to/docs/#using-remote-sub-pages "Direct link to heading")
...
![Public config in a gist demo](https://i.ibb.co/55jm3LG/how-to-use-remote-config-sub-page.gif)

### Restrictions[#](https://dashy.to/docs/#restrictions "Direct link to heading")
...
## Sub-Items[#](https://dashy.to/docs/#sub-items "Direct link to heading")
