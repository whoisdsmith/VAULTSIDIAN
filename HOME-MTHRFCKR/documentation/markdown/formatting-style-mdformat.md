...
Mdformat makes sure to only change style, not content. Once converted to HTML and rendered on screen, formatted Markdown should yield a result that is visually identical to the unformatted document.

## Headings[¶](https://mdformat.readthedocs.io/en/stable/users/style.html#headings "Permalink to this headline")
...
## Bullet lists[¶](https://mdformat.readthedocs.io/en/stable/users/style.html#bullet-lists "Permalink to this headline")

Mdformat uses `-` as the bullet list marker. In the case of consecutive bullet lists, mdformat alternates between `-` and `*` markers.

## Ordered lists[¶](https://mdformat.readthedocs.io/en/stable/users/style.html#ordered-lists "Permalink to this headline")
...
## Code blocks[¶](https://mdformat.readthedocs.io/en/stable/users/style.html#code-blocks "Permalink to this headline")
...
## Code spans[¶](https://mdformat.readthedocs.io/en/stable/users/style.html#code-spans "Permalink to this headline")
...
## Inline links[¶](https://mdformat.readthedocs.io/en/stable/users/style.html#inline-links "Permalink to this headline")
...
## Reference links[¶](https://mdformat.readthedocs.io/en/stable/users/style.html#reference-links "Permalink to this headline")
...
## Paragraph Word wrapping[¶](https://mdformat.readthedocs.io/en/stable/users/style.html#paragraph-word-wrapping "Permalink to this headline")
...
## Thematic breaks[¶](https://mdformat.readthedocs.io/en/stable/users/style.html#thematic-breaks "Permalink to this headline")
...
## Whitespace[¶](https://mdformat.readthedocs.io/en/stable/users/style.html#whitespace "Permalink to this headline")
