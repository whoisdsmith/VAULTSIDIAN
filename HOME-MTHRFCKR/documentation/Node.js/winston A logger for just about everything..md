...
[![Version npm](https://camo.githubusercontent.com/d426a07bc8748f87302df1562db3dc7bb17f9a8d3a9d75436a3b7610938ee73a/68747470733a2f2f696d672e736869656c64732e696f2f6e706d2f762f77696e73746f6e2e7376673f7374796c653d666c61742d737175617265)](https://www.npmjs.com/package/winston) [![npm Downloads](https://camo.githubusercontent.com/d9a53f69b35a6d589b018f9f466a2654cc620100ac8cbdafa24560953df39678/68747470733a2f2f696d672e736869656c64732e696f2f6e706d2f646d2f77696e73746f6e2e7376673f7374796c653d666c61742d737175617265)](https://npmcharts.com/compare/winston?minimal=true) [![build status](https://github.com/winstonjs/winston/actions/workflows/ci.yml/badge.svg)](https://github.com/winstonjs/winston/actions/workflows/ci.yml) [![coverage status](https://camo.githubusercontent.com/13918222fb9b9c0f3b887ab4cf61a7be8f00dd1432c323c58096eb7f72770596/68747470733a2f2f636f766572616c6c732e696f2f7265706f732f6769746875622f77696e73746f6e6a732f77696e73746f6e2f62616467652e7376673f6272616e63683d6d6173746572)](https://coveralls.io/github/winstonjs/winston?branch=master)

[![NPM](https://camo.githubusercontent.com/45e852f3dd0944ad6fe31136d170cec5fe32d15444c3d17c10ce02ba0739505d/68747470733a2f2f6e6f6465692e636f2f6e706d2f77696e73746f6e2e706e673f646f776e6c6f6164733d7472756526646f776e6c6f616452616e6b3d74727565)](https://nodei.co/npm/winston/)

[![Join the chat at https://gitter.im/winstonjs/winston](https://camo.githubusercontent.com/5dbac0213da25c445bd11f168587c11a200ba153ef3014e8408e462e410169b3/68747470733a2f2f6261646765732e6769747465722e696d2f4a6f696e253230436861742e737667)](https://gitter.im/winstonjs/winston?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)

## winston@3

See the [Upgrade Guide](https://github.com/winstonjs/winston/blob/master/UPGRADE-3.0.md) for more information. Bug reports and PRs welcome!

## Looking for `winston@2.x` Documentation?

Please note that the documentation below is for `winston@3`. [Read the `winston@2.x` documentation](https://github.com/winstonjs/winston/tree/2.x).
...
TL;DR? Check out the [quick start example](https://github.com/winstonjs/winston/blob/master/examples/quick-start.js) in `./examples/`. There are a number of other examples in [`./examples/*.js`](https://github.com/winstonjs/winston/tree/master/examples). Don't see an example you think should be there? Submit a pull request to add it!
...
-   [Motivation](https://github.com/winstonjs/winston#motivation)
-   [Quick Start](https://github.com/winstonjs/winston#quick-start)
-   [Usage](https://github.com/winstonjs/winston#usage)
-   [Table of Contents](https://github.com/winstonjs/winston#table-of-contents)
-   [Logging](https://github.com/winstonjs/winston#logging)
    -   [Creating your logger](https://github.com/winstonjs/winston#creating-your-own-logger)
    -   [Streams, `objectMode`, and `info` objects](https://github.com/winstonjs/winston#streams-objectmode-and-info-objects)
-   [Formats](https://github.com/winstonjs/winston#formats)
    -   [Combining formats](https://github.com/winstonjs/winston#combining-formats)
    -   [String interpolation](https://github.com/winstonjs/winston#string-interpolation)
    -   [Filtering `info` Objects](https://github.com/winstonjs/winston#filtering-info-objects)
    -   [Creating custom formats](https://github.com/winstonjs/winston#creating-custom-formats)
-   [Logging levels](https://github.com/winstonjs/winston#logging-levels)
    -   [Using logging levels](https://github.com/winstonjs/winston#using-logging-levels)
    -   [Using custom logging levels](https://github.com/winstonjs/winston#using-custom-logging-levels)
-   [Transports](https://github.com/winstonjs/winston#transports)
    -   [Multiple transports of the same type](https://github.com/winstonjs/winston#multiple-transports-of-the-same-type)
    -   [Adding Custom Transports](https://github.com/winstonjs/winston#adding-custom-transports)
    -   [Common Transport options](https://github.com/winstonjs/winston#common-transport-options)
-   [Exceptions](https://github.com/winstonjs/winston#exceptions)
    -   [Handling Uncaught Exceptions with winston](https://github.com/winstonjs/winston#handling-uncaught-exceptions-with-winston)
    -   [To Exit or Not to Exit](https://github.com/winstonjs/winston#to-exit-or-not-to-exit)
-   [Rejections](https://github.com/winstonjs/winston#rejections)
    -   [Handling Uncaught Promise Rejections with winston](https://github.com/winstonjs/winston#handling-uncaught-promise-rejections-with-winston)
-   [Profiling](https://github.com/winstonjs/winston#profiling)
-   [Streaming Logs](https://github.com/winstonjs/winston#streaming-logs)
-   [Querying Logs](https://github.com/winstonjs/winston#querying-logs)
-   [Further Reading](https://github.com/winstonjs/winston#further-reading)
    -   [Using the default logger](https://github.com/winstonjs/winston#using-the-default-logger)
    -   [Awaiting logs to be written in `winston`](https://github.com/winstonjs/winston#awaiting-logs-to-be-written-in-winston)
    -   [Working with multiple Loggers in `winston`](https://github.com/winstonjs/winston#working-with-multiple-loggers-in-winston)
-   [Installation](https://github.com/winstonjs/winston#installation)
-   [Run Tests](https://github.com/winstonjs/winston#run-tests)

## Logging

Logging levels in `winston` conform to the severity ordering specified by [RFC5424](https://tools.ietf.org/html/rfc5424): *severity of all levels is assumed to be numerically **ascending** from most important to least important.*
...
Log only if [`info.level`](https://github.com/winstonjs/winston#streams-objectmode-and-info-objects) less than or equal to this level
...
Formatting for `info` messages (see: [Formats](https://github.com/winstonjs/winston#formats))
...
In `winston`, both `Logger` and `Transport` instances are treated as [`objectMode`](https://nodejs.org/api/stream.html#stream_object_mode) streams that accept an `info` object.
...
Formats in `winston` can be accessed from `winston.format`. They are implemented in [`logform`](https://github.com/winstonjs/logform), a separate module from `winston`. This allows flexibility when writing your own transports in case you wish to include a default format with your transport.
...
To see what built-in formats are available and learn more about creating your own custom logging formats, see [`logform`](https://github.com/winstonjs/logform#readme).
...
The `log` method provides the string interpolation using [util.format](https://nodejs.org/dist/latest/docs/api/util.html#util_util_format_format_args). **It must be enabled using `format.splat()`.**
...
-   **A falsey value** indicating that the `info` argument should be ignored by the caller. (See: [Filtering `info` Objects](https://github.com/winstonjs/winston#filtering-info-objects)) below.
...
There are several [core transports](https://github.com/winstonjs/winston/blob/master/docs/transports.md#winston-core) included in `winston`, which leverage the built-in networking and file I/O offered by Node.js core. In addition, there are [additional transports](https://github.com/winstonjs/winston/blob/master/docs/transports.md#additional-transports) written by members of the community.
...
As every transport inherits from [winston-transport](https://github.com/winstonjs/winston-transport), it's possible to set a custom format and a custom log level on each transport separately:
...
With `winston`, it is possible to catch and log `uncaughtRejection` events from your process. With your own logger instance you can enable this behavior when it's created or later on in your applications lifecycle:
...
`winston` supports querying of logs with Loggly-like options. [See Loggly Search API](https://www.loggly.com/docs/api-retrieving-data/). Specifically: `File`, `Couchdb`, `Redis`, `Loggly`, `Nssocket`, and `Http`.
...
For more documentation about working with each individual transport supported by `winston` see the [`winston` Transports](https://github.com/winstonjs/winston/blob/master/docs/transports.md) document.
...
All of the winston tests are written with [`mocha`](https://mochajs.org/), [`nyc`](https://github.com/istanbuljs/nyc), and [`assume`](https://github.com/bigpipe/assume). They can be run with `npm`.

### Author: [Charlie Robbins](http://github.com/indexzero)

### Contributors: [Jarrett Cruger](https://github.com/jcrugzz), [David Hyde](https://github.com/dabh), [Chris Alderson](https://github.com/chrisalderson)
