...
## [#](https://pipedream.com/docs/#getting-started) Getting Started

To get started, [sign up for a free account (opens new window)](https://pipedream.com/auth/signup) (no credit card required) and follow our [quickstart guide](https://pipedream.com/docs/quickstart/) to create your first workflow.

![build, test,deploy](https://pipedream.com/docs/assets/img/getting-started5.46baf27d.png)
...
The platform processes billions of events and is built and [priced (opens new window)](https://pipedream.com/pricing/) for use at scale. [Our team (opens new window)](https://pipedream.com/about) has built internet scale applications and managed data pipelines in excess of 10 million events per second (EPS) at startups and high-growth environments like BrightRoll, Yahoo!, Affirm and Instacart.
...
Pipedream maintains an [open source component registry (opens new window)](https://github.com/pipedreamhq/pipedream/) on GitHub so you can avoid writing boilerplate code for common API integrations. Use components as no code building blocks in workflows, or use them to scaffold code that you can customize. You can also [create a PR contribute new or enhanced components](https://pipedream.com/docs/components/guidelines/#process) via GitHub.

## [#](https://pipedream.com/docs/#contributing) Contributing
...
If you have any questions or feedback, please [reach out in our community forum (opens new window)](https://pipedream.com/community).

## [#](https://pipedream.com/docs/#service-status) Service Status

Pipedream operates a status page at [https://status.pipedream.com (opens new window)](https://status.pipedream.com/). That page displays the uptime history and current status of every Pipedream service.

When incidents occur, updates are published to the **#incidents** channel of [Pipedream's Slack Community (opens new window)](https://pipedream.com/support) and to the [@PipedreamStatus (opens new window)](https://twitter.com/PipedreamStatus) account on Twitter. On the status page itself, you can also subscribe to updates directly.
