...
3. Click **Reconnect**
4. You'll be taken to a page where you can reconnect the service to [[../../ifttt/ifttt.md]]
...
To reconnect the service, follow the steps above, but this time click **Remove**. Disconnecting your service may disable related Applets and connections on your [[../../ifttt/ifttt.md]] account so be prepared to reconnect them afterward.

## Search for service-specific tips online

Search **\[service name\] IFTTT help** online - it's possible that the service has specific requirements for how to use [[../../ifttt/ifttt.md]]. For example, some services only offer [[../../ifttt/ifttt.md]] support with certain plans on their product.
...
If you are using a connection with an IoT device that is not running successfully, try a full reset of the device, double-check that you have connected [[../../ifttt/ifttt.md]] to the same device account where it is registered, and ensure your internet connection is strong. Also, confirm that your device is [[../../ifttt/ifttt.md]] compatible.
...
If the above information doesn't help to get your Applet working, please contact the service owner. Most services on the [[../../ifttt/ifttt.md]] platform have tools to help them diagnose user issues as they come up. You can often locate a service's support info by searching for **\[service name\] IFTTT help** online.
