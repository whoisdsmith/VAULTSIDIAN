---
created: 2022-08-09T17:03:10 (UTC -04:00)
tags: []
...
All app configuration is specified in [`/public/conf.yml`](https://github.com/Lissy93/dashy/blob/master/public/conf.yml) which is in [YAML Format](https://yaml.org/) format. If you're using Docker, this file can be passed in as a volume. Changes can either be made directly to this file, or done [through the UI](https://dashy.to/docs/#editing-config-through-the-ui). From the UI you can also export, backup, reset, validate and download your configuration file.

## There Are Three Ways to Edit the config[#](https://dashy.to/docs/#there-are-three-ways-to-edit-the-config "Direct link to heading")
...
## Tips[#](https://dashy.to/docs/#tips "Direct link to heading")
...
-   It is recommended to keep a backup of your config file. You can download it under Config menu, or use the [Cloud Backup](https://dashy.to/docs/backup-restore) feature.
...
-   Once you have finished configuring your dashboard, you can choose to [disable UI config](https://dashy.to/docs/#preventing-changes) if you wish
...
-   [**`pageInfo`**](https://dashy.to/docs/#pageinfo) - Header text, footer, title, navigation, etc
    -   [`navLinks`](https://dashy.to/docs/#pageinfonavlinks-optional) - Links to display in the navigation bar
-   [**`pages`**](https://dashy.to/docs/#pages-optional) - List of additional config files, for multi-page dashboards
-   [**`appConfig`**](https://dashy.to/docs/#appconfig-optional) - Main application settings
    -   [`webSearch`](https://dashy.to/docs/#appconfigwebsearch-optional) - Configure web search engine options
    -   [`hideComponents`](https://dashy.to/docs/#appconfighidecomponents-optional) - Show/ hide page components
    -   [`auth`](https://dashy.to/docs/#appconfigauth-optional) - Built-in authentication setup
        -   [`users`](https://dashy.to/docs/#appconfigauthusers-optional) - List or users (for simple auth)
        -   [`keycloak`](https://dashy.to/docs/#appconfigauthkeycloak-optional) - Auth config for Keycloak
-   [**`sections`**](https://dashy.to/docs/#section) - List of sections
    -   [`displayData`](https://dashy.to/docs/#sectiondisplaydata-optional) - Section display settings
        -   [`show/hideForKeycloakUsers`](https://dashy.to/docs/#sectiondisplaydatahideforkeycloakusers-sectiondisplaydatashowforkeycloakusers-itemdisplaydatahideforkeycloakusers-and-itemdisplaydatashowforkeycloakusers) - Set user controls
    -   [`icon`](https://dashy.to/docs/#sectionicon-and-sectionitemicon) - Icon for a section
    -   [`items`](https://dashy.to/docs/#sectionitem) - List of items
        -   [`icon`](https://dashy.to/docs/#sectionicon-and-sectionitemicon) - Icon for an item
        -   [`displayData`](https://dashy.to/docs/#itemdisplaydata-optional) - Item display settings
            -   [`show/hideForKeycloakUsers`](https://dashy.to/docs/#sectiondisplaydatahideforkeycloakusers-sectiondisplaydatashowforkeycloakusers-itemdisplaydatahideforkeycloakusers-and-itemdisplaydatashowforkeycloakusers) - Set user controls
    -   [`widgets`](https://dashy.to/docs/#sectionwidget-optional) - List of widgets
-   [**Notes**](https://dashy.to/docs/#notes)
    -   [Editing Config through the UI](https://dashy.to/docs/#editing-config-through-the-ui)
    -   [About YAML](https://dashy.to/docs/#about-yaml)
    -   [Config Saving Methods](https://dashy.to/docs/#config-saving-methods)
    -   [Preventing Changes](https://dashy.to/docs/#preventing-changes)
    -   [Example](https://dashy.to/docs/#example)

___

# Top-Level Fields[#](https://dashy.to/docs/#top-level-fields "Direct link to heading")

| **Field** | **Type** | **Required** | **Description** |
| --- | --- | --- | --- |
| **`pageInfo`** | `object` | Required | Basic meta data like title, description, nav bar links, footer text. See [`pageInfo`](https://dashy.to/docs/#pageinfo) |
| **`appConfig`** | `object` | *Optional* | Settings related to how the app functions, including API keys and global styles. See [`appConfig`](https://dashy.to/docs/#appconfig-optional) |
| **`sections`** | `array` | Required | An array of sections, each containing an array of items, which will be displayed as links. See [`section`](https://dashy.to/docs/#section) |
| **`pages`** | `array` | *Optional* | An array additional config files, used for multi-page dashboards. See [`pages`](https://dashy.to/docs/#pages-optional) |

**[⬆️ Back to Top](https://dashy.to/docs/#)**

# `PageInfo`[#](https://dashy.to/docs/#pageinfo "Direct link to heading")
...
| **`navLinks`** | `array` | *Optional* | Optional list of a maximum of 6 links, which will be displayed in the navigation bar. See [`navLinks`](https://dashy.to/docs/#pageinfonavlinks-optional) |
...
# `pageInfo.navLinks` *(optional)*[#](https://dashy.to/docs/#pageinfonavlinks-optional "Direct link to heading")
...
| **`target`** | `string` | *Optional* | The opening method (external links only). Can be either `newtab`, `sametab`, `top` or `parent`. Defaults to `newtab` |

**[⬆️ Back to Top](https://dashy.to/docs/#)**

# `pages[]` *(optional)*[#](https://dashy.to/docs/#pages-optional "Direct link to heading")
...
# `appConfig` *(optional)*[#](https://dashy.to/docs/#appconfig-optional "Direct link to heading")
...
| **`webSearch`** | `object` | *Optional* | Configuration options for the web search feature, set your default search engine, opening method or disable web search. See [`webSearch`](https://dashy.to/docs/#appconfigwebsearch-optional) |
...
| **`faviconApi`** | `enum` | *Optional* | Only applicable if you are using favicons for item icons. Specifies which service to use to resolve favicons. Set to `local` to do this locally, without using an API. Services running locally will use this option always. Available options are: `local`, `faviconkit`, `iconhorse`, `google`, `clearbit`, `webmasterapi` and `allesedv`. Defaults to `faviconkit`. See [Icons](https://dashy.to/docs/icons#favicons) for more info |
| **`auth`** | `object` | *Optional* | All settings relating to user authentication. See [`auth`](https://dashy.to/docs/#appconfigauth-optional) |
...
| **`customColors`** | `object` | *Optional* | Enables you to apply a custom color palette to any given theme. Use the theme name (lowercase) as the key, for an object including key-value-pairs, with the color variable name as keys, and 6-digit hex code as value. See [Theming](https://dashy.to/docs/theming#modifying-theme-colors) for more info |
...
| **`hideComponents`** | `object` | *Optional* | A list of key page components (header, footer, search, settings, etc) that are present by default, but can be removed using this option. See [`appConfig.hideComponents`](https://dashy.to/docs/#appconfighideComponents-optional) |
...
| **`enableErrorReporting`** | `boolean` | *Optional* | Enable reporting of unexpected errors and crashes. This is off by default, and **no data will ever be captured unless you explicitly enable it**. Turning on error reporting helps previously unknown bugs get discovered and fixed. Dashy uses [Sentry](https://github.com/getsentry/sentry) for error reporting. Defaults to `false`. |
...
# `appConfig.auth` *(optional)*[#](https://dashy.to/docs/#appconfigauth-optional "Direct link to heading")

| **Field** | **Type** | **Required** | **Description** |
| --- | --- | --- | --- |
| **`users`** | `array` | *Optional* | An array of objects containing usernames and hashed passwords. If this is not provided, then authentication will be off by default, and you will not need any credentials to access the app. See [`appConfig.auth.users`](https://dashy.to/docs/#appconfigauthusers-optional).  
**Note** this method of authentication is handled on the client side, so for security critical situations, it is recommended to use an [alternate authentication method](https://dashy.to/docs/authentication#alternative-authentication-methods). |
| **`enableKeycloak`** | `boolean` | *Optional* | If set to `true`, then authentication using Keycloak will be anabled. Note that you need to have an instance running, and have also configured `auth.keycloak`. Defaults to `false` |
| **`keycloak`** | `object` | *Optional* | Config options to point Dashy to your Keycloak server. Requires `enableKeycloak: true`. See [`auth.keycloak`](https://dashy.to/docs/#appconfigauthkeycloak-optional) for more info |
...
For more info, see the **[Authentication Docs](https://dashy.to/docs/authentication)**

**[⬆️ Back to Top](https://dashy.to/docs/#)**

# `appConfig.auth.users` *(optional)*[#](https://dashy.to/docs/#appconfigauthusers-optional "Direct link to heading")
...
# `appConfig.auth.keycloak` *(optional)*[#](https://dashy.to/docs/#appconfigauthkeycloak-optional "Direct link to heading")
...
# `appConfig.webSearch` *(optional)*[#](https://dashy.to/docs/#appconfigwebsearch-optional "Direct link to heading")
...
# `appConfig.hideComponents` *(optional)*[#](https://dashy.to/docs/#appconfighidecomponents-optional "Direct link to heading")
...
# `section`[#](https://dashy.to/docs/#section "Direct link to heading")

| **Field** | **Type** | **Required** | **Description** |
| --- | --- | --- | --- |
| **`name`** | `string` | Required | The title for the section |
| **`icon`** | `string` | *Optional* | An single icon to be displayed next to the title. See [`section.icon`](https://dashy.to/docs/#sectionicon-and-sectionitemicon) |
| **`items`** | `array` | *Optional* | An array of items to be displayed within the section. See [`item`](https://dashy.to/docs/#sectionitem). Sections must include either 1 or more items, or 1 or more widgets. |
| **`widgets`** | `array` | *Optional* | An array of widgets to be displayed within the section. See [`widget`](https://dashy.to/docs/#sectionwidget-optional) |
| **`displayData`** | `object` | *Optional* | Meta-data to optionally overide display settings for a given section. See [`displayData`](https://dashy.to/docs/#sectiondisplaydata-optional) |

**[⬆️ Back to Top](https://dashy.to/docs/#)**

# `section.item`[#](https://dashy.to/docs/#sectionitem "Direct link to heading")
...
| **`icon`** | `string` | *Optional* | The icon for a given item. Can be a font-awesome icon, favicon, remote URL or local URL. See [`item.icon`](https://dashy.to/docs/#sectionicon-and-sectionitemicon) |
...
| **`statusCheckAllowInsecure`** | `boolean` | *Optional* | By default, any request to insecure content will be blocked. Setting this option to `true` will disable the `rejectUnauthorized` option, enabling you to ping non-HTTPS services for the current item. Defaults to `false` |
| **`statusCheckAcceptCodes`** | `string` | *Optional* | If your service's response code is anything other than 2xx, then you can opt to specify an alternative success code. E.g. if you expect your server to return 403, but still want the status indicator to be green, set this value to `403` |
| **`statusCheckMaxRedirects`** | `number` | *Optional* | If your service redirects to another page, and you would like status checks to follow redirects, then specify the maximum number of redirects here. Defaults to `0` / will not follow redirects |
...
| **`displayData`** | `object` | *Optional* | Meta-data to optionally overide display settings for a given item. See [`displayData`](https://dashy.to/docs/#itemdisplaydata-optional) |

**[⬆️ Back to Top](https://dashy.to/docs/#)**

# `item.displayData` *(optional)*[#](https://dashy.to/docs/#itemdisplaydata-optional "Direct link to heading")
...
# `section.widget` *(optional)*[#](https://dashy.to/docs/#sectionwidget-optional "Direct link to heading")

| **Field** | **Type** | **Required** | **Description** |
| --- | --- | --- | --- |
| **`type`** | `string` | Required | The widget type. See [Widget Docs](https://dashy.to/docs/widgets) for full list of supported widgets |
| **`options`** | `object` | *Optional* | Some widgets accept either optional or required additional options. Again, see the [Widget Docs](https://dashy.to/docs/widgets) for full list of options |
| **`updateInterval`** | `number` | *Optional* | You can keep a widget constantly updated by specifying an update interval, in seconds. See [Continuous Updates Docs](https://dashy.to/docs/widgets#continuous-updates) for more info |
| **`useProxy`** | `boolean` | *Optional* | Some widgets make API requests to services that are not CORS-enabled. For these instances, you will need to route requests through a proxy, Dashy has a built in CORS-proxy, which you can use by setting this option to `true`. Defaults to `false`. See the [Proxying Requests Docs](https://dashy.to/docs/widgets#proxying-requests) for more info |
| **`timeout`** | `number` | *Optional* | Request timeout in milliseconds, defaults to ½ a second (`500`) |

**[⬆️ Back to Top](https://dashy.to/docs/#)**

# `section.displayData` *(optional)*[#](https://dashy.to/docs/#sectiondisplaydata-optional "Direct link to heading")
...
# `section.icon` And `section.item.icon`[#](https://dashy.to/docs/#sectionicon-and-sectionitemicon "Direct link to heading")

| **Field** | **Type** | **Required** | **Description** |
| --- | --- | --- | --- |
| **`icon`** | `string` | *Optional* | The icon for a given item or section.  
See [Icon Docs](https://dashy.to/docs/icons) for all available supported icon types, including: auto-fetched favicons, generative icons, emoji icons, home-lab service logos, font-awesome, simple-icons, material icons, and icons specified by URL |

**[⬆️ Back to Top](https://dashy.to/docs/#)**

# `section.displayData.hideForKeycloakUsers`, `section.displayData.showForKeycloakUsers`, `item.displayData.hideForKeycloakUsers` And `item.displayData.showForKeycloakUsers`[#](https://dashy.to/docs/#sectiondisplaydatahideforkeycloakusers-sectiondisplaydatashowforkeycloakusers-itemdisplaydatahideforkeycloakusers-and-itemdisplaydatashowforkeycloakusers "Direct link to heading")
...
# Editing Config through the UI[#](https://dashy.to/docs/#editing-config-through-the-ui "Direct link to heading")
...
[**Interactive Editor**  
![Interactive Editor demo](https://user-images.githubusercontent.com/1862727/139543020-b0576d28-0830-476f-afc8-a815d4de6def.gif)](https://ibb.co/CzkyMNb)  
[**JSON Editor**  
![Config Editor demo](https://raw.githubusercontent.com/Lissy93/dashy/master/docs/assets/config-editor-demo.gif)](https://ibb.co/zRv542H)

# About YAML[#](https://dashy.to/docs/#about-yaml "Direct link to heading")
...
# Config Saving Methods[#](https://dashy.to/docs/#config-saving-methods "Direct link to heading")
...
# Preventing Changes[#](https://dashy.to/docs/#preventing-changes "Direct link to heading")
