---
created: 2022-08-09T17:02:05 (UTC -04:00)
tags: []
...
### How Theme-Switching Works[#](https://dashy.to/docs/#how-theme-switching-works "Direct link to heading")
...
### Modifying Theme Colors[#](https://dashy.to/docs/#modifying-theme-colors "Direct link to heading")

Themes can be modified either through the UI, using the color picker menu (to the right of the theme dropdown), or directly in the config file, under `appConfig.customColors`. Here you can specify the value for any of the [available CSS variables](https://dashy.to/docs/#css-variables).
...
### Adding your own Theme[#](https://dashy.to/docs/#adding-your-own-theme "Direct link to heading")
...
### Setting Custom CSS in the UI[#](https://dashy.to/docs/#setting-custom-css-in-the-ui "Direct link to heading")
...
### Page-Specific Styles[#](https://dashy.to/docs/#page-specific-styles "Direct link to heading")
...
### Loading External Stylesheets[#](https://dashy.to/docs/#loading-external-stylesheets "Direct link to heading")
...
### Hard-Coding Section or Item Colors[#](https://dashy.to/docs/#hard-coding-section-or-item-colors "Direct link to heading")
...
### Typography[#](https://dashy.to/docs/#typography "Direct link to heading")
...
### CSS Variables[#](https://dashy.to/docs/#css-variables "Direct link to heading")
...
#### Top-Level Variables[#](https://dashy.to/docs/#top-level-variables "Direct link to heading")
...
#### Targeted Color Variables[#](https://dashy.to/docs/#targeted-color-variables "Direct link to heading")
...
#### Non-Color Variables[#](https://dashy.to/docs/#non-color-variables "Direct link to heading")
...
#### Action Colors[#](https://dashy.to/docs/#action-colors "Direct link to heading")
