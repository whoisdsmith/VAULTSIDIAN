---
created: 2022-08-09T17:03:40 (UTC -04:00)
tags: []
...
-   [Providing Assets](https://dashy.to/docs/#providing-assets)
-   [Running Commands](https://dashy.to/docs/#running-commands)
-   [Healthchecks](https://dashy.to/docs/#healthchecks)
-   [Logs and Performance](https://dashy.to/docs/#logs-and-performance)
-   [Auto-Starting at Boot](https://dashy.to/docs/#auto-starting-at-system-boot)
-   [Updating](https://dashy.to/docs/#updating)
-   [Backing Up](https://dashy.to/docs/#backing-up)
-   [Scheduling](https://dashy.to/docs/#scheduling)
-   [SSL Certificates](https://dashy.to/docs/#ssl-certificates)
-   [Authentication](https://dashy.to/docs/#authentication)
-   [Managing with Compose](https://dashy.to/docs/#managing-containers-with-docker-compose)
-   [Environmental Variables](https://dashy.to/docs/#passing-in-environmental-variables)
-   [Setting Headers](https://dashy.to/docs/#setting-headers)
-   [Remote Access](https://dashy.to/docs/#remote-access)
-   [Custom Domain](https://dashy.to/docs/#custom-domain)
-   [Securing Containers](https://dashy.to/docs/#container-security)
-   [Web Server Configuration](https://dashy.to/docs/#web-server-configuration)
-   [Running a Modified App](https://dashy.to/docs/#running-a-modified-version-of-the-app)
-   [Building your Own Container](https://dashy.to/docs/#building-your-own-container)

___

## Providing Assets[#](https://dashy.to/docs/#providing-assets "Direct link to heading")
...
## Running Commands[#](https://dashy.to/docs/#running-commands "Direct link to heading")
...
Dashy has several commands that can be used for various tasks, you can find a list of these either in the [Developing Docs](https://dashy.to/docs/developing#project-commands), or by looking at the [`package.json`](https://github.com/Lissy93/dashy/blob/master/package.json#L5). These can be used by running `yarn [command-name]`.

**[⬆️ Back to Top](https://dashy.to/docs/#)**

___

## Healthchecks[#](https://dashy.to/docs/#healthchecks "Direct link to heading")
...
## Auto-Starting at System Boot[#](https://dashy.to/docs/#auto-starting-at-system-boot "Direct link to heading")
...
To restart the container after something within it has crashed, consider using [`docker-autoheal`](https://github.com/willfarrell/docker-autoheal) by @willfarrell, a service that monitors and restarts unhealthy containers. For more info, see the [Healthchecks](https://dashy.to/docs/#healthchecks) section above.

**[⬆️ Back to Top](https://dashy.to/docs/#)**

___

## Updating[#](https://dashy.to/docs/#updating "Direct link to heading")
...
### Updating Docker Container[#](https://dashy.to/docs/#updating-docker-container "Direct link to heading")
...
### Automatic Docker Updates[#](https://dashy.to/docs/#automatic-docker-updates "Direct link to heading")
...
### Updating Dashy from Source[#](https://dashy.to/docs/#updating-dashy-from-source "Direct link to heading")
...
## Backing Up[#](https://dashy.to/docs/#backing-up "Direct link to heading")

### Backing Up Containers[#](https://dashy.to/docs/#backing-up-containers "Direct link to heading")
...
### Backing Up Volumes[#](https://dashy.to/docs/#backing-up-volumes "Direct link to heading")
...
### Dashy-Specific Backup[#](https://dashy.to/docs/#dashy-specific-backup "Direct link to heading")
...
## Scheduling[#](https://dashy.to/docs/#scheduling "Direct link to heading")
...
## SSL Certificates[#](https://dashy.to/docs/#ssl-certificates "Direct link to heading")
...
### Auto-SSL[#](https://dashy.to/docs/#auto-ssl "Direct link to heading")
...
### Getting a Self-Signed SSL Certificate[#](https://dashy.to/docs/#getting-a-self-signed-ssl-certificate "Direct link to heading")
...
### Passing a Self-Signed Certificate to Dashy[#](https://dashy.to/docs/#passing-a-self-signed-certificate-to-dashy "Direct link to heading")
...
```
docker run -d \  -p 8080:80 \  -v ~/my-private-key.key:/etc/ssl/certs/dashy-priv.key:ro \  -v ~/my-public-key.pem:/etc/ssl/certs/dashy-pub.pem:ro \  lissy93/dashy:latest
```
...
## Authentication[#](https://dashy.to/docs/#authentication "Direct link to heading")
...
## Managing Containers with Docker Compose[#](https://dashy.to/docs/#managing-containers-with-docker-compose "Direct link to heading")
...
```
---version: "3.8"services:  dashy:    container_name: Dashy    image: lissy93/dashy    volumes:      - /root/my-config.yml:/app/public/conf.yml    ports:      - 4000:80    environment:      - BASE_URL=/my-dashboard    restart: unless-stopped    healthcheck:      test: ['CMD', 'node', '/app/services/healthcheck']      interval: 1m30s      timeout: 10s      retries: 3      start_period: 40s
```
...
## Setting Headers[#](https://dashy.to/docs/#setting-headers "Direct link to heading")
...
### Example Headers[#](https://dashy.to/docs/#example-headers "Direct link to heading")

-   [Caddy](https://dashy.to/docs/#caddy)
-   [NGINX](https://dashy.to/docs/#nginx)
-   [Træfɪk](https://dashy.to/docs/#traefik)
...
#### Caddy[#](https://dashy.to/docs/#caddy "Direct link to heading")
...
#### NGINX[#](https://dashy.to/docs/#nginx "Direct link to heading")
...
#### Apache[#](https://dashy.to/docs/#apache "Direct link to heading")
...
#### Squid[#](https://dashy.to/docs/#squid "Direct link to heading")
...
## Remote Access[#](https://dashy.to/docs/#remote-access "Direct link to heading")

-   [WireGuard](https://dashy.to/docs/#wireguard)
-   [Reverse SSH Tunnel](https://dashy.to/docs/#reverse-ssh-tunnel)
-   [TCP Tunnel](https://dashy.to/docs/#tcp-tunnel)

### WireGuard[#](https://dashy.to/docs/#wireguard "Direct link to heading")
...
```
# Server file[Interface]# Which networks does my interface belong to? Notice: /24 and /64Address = 10.5.0.1/24, 2001:470:xxxx:xxxx::1/64PrivateKey = xxxListenPort = 51820
# Peer 1[Peer]PublicKey = xxx# Which source IPs can I expect from that peer? Notice: /32 and /128AllowedIps = 10.5.0.35/32, 2001:470:xxxx:xxxx::746f:786f/128
# Peer 2[Peer]PublicKey = xxx# Which source IPs can I expect from that peer? This one has a LAN which can# access hosts/jails without NAT.# Peer 2 has a single IP address inside the VPN: it's 10.5.0.25/32AllowedIps = 10.5.0.25/32,10.21.10.0/24,10.21.20.0/24,10.21.30.0/24,10.31.0.0/24,2001:470:xxxx:xxxx::ca:571e/128
```

**Example Client Config**

```
[Interface]# Which networks does my interface belong to? Notice: /24 and /64Address = 10.5.0.35/24, 2001:470:xxxx:xxxx::746f:786f/64PrivateKey = xxx
# Server[Peer]PublicKey = xxx# I want to route everything through the server, both IPv4 and IPv6. All IPs are# thus available through the Server, and I can expect packets from any IP to# come from that peer.AllowedIPs = 0.0.0.0/0, ::0/0# Where is the server on the internet? This is a public address. The port# (:51820) is the same as ListenPort in the [Interface] of the Server file aboveEndpoint = 1.2.3.4:51820# Usually, clients are behind NAT. to keep the connection running, keep alive.PersistentKeepalive = 15
```
...
### Reverse SSH Tunnel[#](https://dashy.to/docs/#reverse-ssh-tunnel "Direct link to heading")
...
### TCP Tunnel[#](https://dashy.to/docs/#tcp-tunnel "Direct link to heading")
...
It's recommended to use authentication for any publicly accessible service. Dashy has an [Auth](https://dashy.to/docs/authentication) feature built in, but an even easier method it to use the [`-auth`](https://ngrok.com/docs#http-auth) switch. E.g. `ngrok http -auth=”username:password123” 8080`
...
## Custom Domain[#](https://dashy.to/docs/#custom-domain "Direct link to heading")

-   [Using DNS](https://dashy.to/docs/#using-nginx)
-   [Using NGINX](https://dashy.to/docs/#using-dns)

### Using DNS[#](https://dashy.to/docs/#using-dns "Direct link to heading")
...
### Using NGINX[#](https://dashy.to/docs/#using-nginx "Direct link to heading")

If you're using NGINX, then you can use your own domain name, with a config similar to the below example.

```
upstream dashy {  server 127.0.0.1:32400;}
server {  listen         80;  server_name    dashy.mydomain.com;
...
```
dashy.example.com {    reverse_proxy / nginx:80}
```
...
## Container Security[#](https://dashy.to/docs/#container-security "Direct link to heading")

-   [Keep Docker Up-To-Date](https://dashy.to/docs/#keep-docker-up-to-date)
-   [Set Resource Quotas](https://dashy.to/docs/#set-resource-quotas)
-   [Don't Run as Root](https://dashy.to/docs/#dont-run-as-root)
-   [Specify a User](https://dashy.to/docs/#specify-a-user)
-   [Limit Capabilities](https://dashy.to/docs/#limit-capabilities)
-   [Prevent new Privilages being Added](https://dashy.to/docs/#prevent-new-privilages-being-added)
-   [Disable Inter-Container Communication](https://dashy.to/docs/#disable-inter-container-communication)
-   [Don't Expose the Docker Daemon Socket](https://dashy.to/docs/#dont-expose-the-docker-daemon-socket)
-   [Use Read-Only Volumes](https://dashy.to/docs/#use-read-only-volumes)
-   [Set the Logging Level](https://dashy.to/docs/#set-the-logging-level)
-   [Verify Image before Pulling](https://dashy.to/docs/#verify-image-before-pulling)
-   [Specify the Tag](https://dashy.to/docs/#specify-the-tag)
-   [Container Security Scanning](https://dashy.to/docs/#container-security-scanning)
-   [Registry Security](https://dashy.to/docs/#registry-security)
-   [Security Modules](https://dashy.to/docs/#security-modules)

### Keep Docker Up-To-Date[#](https://dashy.to/docs/#keep-docker-up-to-date "Direct link to heading")
...
### Set Resource Quotas[#](https://dashy.to/docs/#set-resource-quotas "Direct link to heading")
...
For example, to run Dashy with max of 1GB ram, and max of 50% of 1 CP core: `docker run -d -p 8080:80 --cpus=".5" --memory="1024m" lissy93/dashy:latest`

### Don't Run as Root[#](https://dashy.to/docs/#dont-run-as-root "Direct link to heading")
...
### Specify a User[#](https://dashy.to/docs/#specify-a-user "Direct link to heading")
...
With Docker run, you specify it like: `docker run --user 1000:1000 -p 8080:80 lissy93/dashy`

Of if you're using Docker-compose, you could use an environmental variable

```
version: "3.8"services:  dashy:    image: lissy93/dashy    user: ${CURRENT_UID}    ports: [ 4000:80 ]
```

And then to set the variable, and start the container, run: `CURRENT_UID=$(id -u):$(id -g) docker-compose up`

### Limit capabilities[#](https://dashy.to/docs/#limit-capabilities "Direct link to heading")
...
Run Command: `docker run --security-opt=no-new-privileges:true -p 8080:80 lissy93/dashy`
...
### Disable Inter-Container Communication[#](https://dashy.to/docs/#disable-inter-container-communication "Direct link to heading")
...
### Don't Expose the Docker Daemon Socket[#](https://dashy.to/docs/#dont-expose-the-docker-daemon-socket "Direct link to heading")
...
### Use Read-Only Volumes[#](https://dashy.to/docs/#use-read-only-volumes "Direct link to heading")
...
```
docker run -d \  -p 8080:80 \  -v ~/dashy-conf.yml:/app/public/conf.yml \  -v ~/dashy-icons:/app/public/item-icons:ro \  -v ~/dashy-theme.scss:/app/src/styles/user-defined-themes.scss:ro \  lissy93/dashy:latest
```
...
### Set the Logging Level[#](https://dashy.to/docs/#set-the-logging-level "Direct link to heading")
...
### Verify Image before Pulling[#](https://dashy.to/docs/#verify-image-before-pulling "Direct link to heading")
...
### Specify the Tag[#](https://dashy.to/docs/#specify-the-tag "Direct link to heading")
...
### Container Security Scanning[#](https://dashy.to/docs/#container-security-scanning "Direct link to heading")
...
### Registry Security[#](https://dashy.to/docs/#registry-security "Direct link to heading")
...
### Security Modules[#](https://dashy.to/docs/#security-modules "Direct link to heading")
...
-   [Apache](https://dashy.to/docs/#apache)
-   [Caddy](https://dashy.to/docs/#caddy)
-   [Firebase](https://dashy.to/docs/#firebase-hosting)
-   [cPanel](https://dashy.to/docs/#cpanel)

### NGINX[#](https://dashy.to/docs/#nginx-1 "Direct link to heading")
...
### Apache[#](https://dashy.to/docs/#apache-1 "Direct link to heading")
...
### Caddy[#](https://dashy.to/docs/#caddy-1 "Direct link to heading")
...
### Firebase Hosting[#](https://dashy.to/docs/#firebase-hosting "Direct link to heading")
...
### cPanel[#](https://dashy.to/docs/#cpanel "Direct link to heading")
