---
created: 2022-08-09T17:03:29 (UTC -04:00)
tags: []
...
See [Management Docs](https://dashy.to/docs/management) for info about securing, monitoring, updating, health checks, auto starting, web server configuration, etc
...
-   [Unraid](https://dashy.to/docs/#unraid)
-   [Synology NAS](https://dashy.to/docs/#synology-nas)
-   [Build from Source](https://dashy.to/docs/#build-from-source)
-   [Hosting with CDN](https://dashy.to/docs/#hosting-with-cdn)
-   [Run as executable](https://dashy.to/docs/#run-as-executable)
-   [Install with NPM](https://dashy.to/docs/#install-with-npm)
-   [Deploy to cloud service](https://dashy.to/docs/#deploy-to-cloud-service)
-   [Use managed instance](https://dashy.to/docs/#use-managed-instance)
...
![](https://i.ibb.co/pjnmbw9/browser-compatibility.png)
