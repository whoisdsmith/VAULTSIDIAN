...
Filter code gives you some control over this logic. Filter code is a bit of JavaScript code (the ES5 flavor, but let's not get *too* technical just yet!) that runs right after a trigger fires.
