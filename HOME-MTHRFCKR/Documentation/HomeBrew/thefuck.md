_The Fuck_ is a magnificent app, inspired by a [@liamosaur](https://twitter.com/liamosaur/) [tweet](https://twitter.com/liamosaur/status/506975850596536320), that corrects errors in previous console commands.

Is _The Fuck_ too slow? [Try the experimental instant mode!](https://github.com/nvbn/thefuck#experimental-instant-mode)
...
1.  [Requirements](https://github.com/nvbn/thefuck#requirements)
2.  [Installations](https://github.com/nvbn/thefuck#installation)
3.  [Updating](https://github.com/nvbn/thefuck#updating)
4.  [How it works](https://github.com/nvbn/thefuck#how-it-works)
5.  [Creating your own rules](https://github.com/nvbn/thefuck#creating-your-own-rules)
6.  [Settings](https://github.com/nvbn/thefuck#settings)
7.  [Third party packages with rules](https://github.com/nvbn/thefuck#third-party-packages-with-rules)
8.  [Experimental instant mode](https://github.com/nvbn/thefuck#experimental-instant-mode)
9.  [Developing](https://github.com/nvbn/thefuck#developing)
10.  [License](https://github.com/nvbn/thefuck#license-mit)
...
##### [Back to Contents](https://github.com/nvbn/thefuck#contents)

## Installation

On macOS or Linux, you can install _The Fuck_ via [Homebrew](https://brew.sh/):
...
On ChromeOS, install _The Fuck_ using [chromebrew](https://github.com/skycocker/chromebrew) with the following command:

On other systems, install _The Fuck_ by using `pip`:

[Alternatively, you may use an OS package manager (OS X, Ubuntu, Arch).](https://github.com/nvbn/thefuck/wiki/Installation)

[#](https://github.com/nvbn/thefuck#manual-installation) It is recommended that you place this command in your `.bash_profile`, `.bashrc`, `.zshrc` or other startup script:
...
To remove _The Fuck_, reverse the installation process:

-   erase or comment _thefuck_ alias line from your Bash, Zsh, Fish, Powershell, tcsh, ... shell config
...
get\_new\_command(command: Command) \-\> str | list\[str\]

Additionally, rules can contain optional functions:

side\_effect(old\_command: Command, fixed\_command: str) \-\> None
...
`settings` is a special object assembled from `~/.config/thefuck/settings.py`, and values from env ([see more below](https://github.com/nvbn/thefuck#settings)).
...
def get\_new\_command(command):
    return 'sudo {}'.format(command.script)

\# Optional:
enabled\_by\_default \= True

def side\_effect(command, fixed\_command):
    subprocess.call('chmod 777 .', shell\=True)

priority \= 1000  \# Lower first, default is 1000

requires\_output \= True

[More examples of rules](https://github.com/nvbn/thefuck/tree/master/thefuck/rules), [utility functions for rules](https://github.com/nvbn/thefuck/tree/master/thefuck/utils.py), [app/os-specific helpers](https://github.com/nvbn/thefuck/tree/master/thefuck/specific/).
...
rules \= \['sudo', 'no\_command'\]
exclude\_rules \= \['git\_push'\]
require\_confirmation \= True
wait\_command \= 10
no\_colors \= False
priority \= {'sudo': 100, 'no\_command': 9999}
debug \= False
history\_limit \= 9999
wait\_slow\_command \= 20
slow\_commands \= \['react-native', 'gradle'\]
num\_close\_matches \= 5
...
export THEFUCK\_RULES='sudo:no\_command'
export THEFUCK\_EXCLUDE\_RULES='git\_pull:git\_push'
export THEFUCK\_REQUIRE\_CONFIRMATION='true'
export THEFUCK\_WAIT\_COMMAND=10
export THEFUCK\_NO\_COLORS='false'
export THEFUCK\_PRIORITY='no\_command=9999:apt\_get=100'
export THEFUCK\_HISTORY\_LIMIT='2000'
export THEFUCK\_NUM\_CLOSE\_MATCHES='5'
...
The default behavior of _The Fuck_ requires time to re-run previous commands. When in instant mode, _The Fuck_ saves time by logging output with [script](https://en.wikipedia.org/wiki/Script_(Unix)), then reading the log.

[![gif with instant mode](https://raw.githubusercontent.com/nvbn/thefuck/master/example_instant_mode.gif)](https://raw.githubusercontent.com/nvbn/thefuck/master/example_instant_mode.gif)
...
See [CONTRIBUTING.md](https://github.com/nvbn/thefuck/blob/master/CONTRIBUTING.md)

## License MIT

Project License can be found [here](https://github.com/nvbn/thefuck/blob/master/LICENSE.md).
