...
[![animated svg of the tldr client displaying the tar command](https://github.com/tldr-pages/tldr/raw/main/images/tldr.svg)](https://github.com/tldr-pages/tldr/blob/main/images/tldr.svg)
...
However, if you just want to browse without installing anything, check out the [PDF version](https://tldr.sh/assets/tldr-book.pdf).

There are also **various other clients** provided by the community, both for the command-line and for other platforms. For a comprehensive list of clients, head over to our [Wiki](https://github.com/tldr-pages/tldr/wiki/tldr-pages-clients).
...
All contributions are welcome! We strive to maintain a [welcoming and collaborative](https://github.com/tldr-pages/tldr/blob/main/GOVERNANCE.md) community. Have a look at the [contributing guidelines](https://github.com/tldr-pages/tldr/blob/main/CONTRIBUTING.md), and go ahead!

If you'd like to contribute to translations, you can visit [https://lukwebsforge.github.io/tldri18n/](https://lukwebsforge.github.io/tldri18n/) to see the current progress of all translations.
