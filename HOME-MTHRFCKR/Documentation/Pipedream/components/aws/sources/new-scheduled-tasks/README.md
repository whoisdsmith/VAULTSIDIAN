...
As described in the [main `README` for AWS sources](Folders/Documentation/Pipedream/components/aws/sources/README.md), this event
...
This section is an extension of [](Folders/Documentation/Pipedream/components/aws/sources/README.md#prerequisites). Make sure to review that document for
more information.
...
**On top of the [](Folders/Documentation/Pipedream/components/aws/sources/README.md#minimum-permissions)** , this policy needs the ability to
...
[here](Folders/Documentation/Pipedream/components/aws/sources/README.md#minimum-permissions)) necessary to both create and delete
these resources.
