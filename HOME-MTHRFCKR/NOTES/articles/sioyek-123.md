...
-   [Download](https://github.com/ahrm/sioyek/releases/latest)
-   [Source Code](https://github.com/ahrm/sioyek)
-   [Documentation](https://sioyek-documentation.readthedocs.io/en/latest/)
-   [Forum](https://github.com/ahrm/sioyek/discussions)
-   [Issues](https://github.com/ahrm/sioyek/issues)
-   [Extensions](https://github.com/ahrm/sioyek-python-extensions)
-   [Features](#)
    -   [Searchable](#searchable)
    -   [Smart Jump](#smartjump)
    -   [Portals](#portals)
...
-   [Buy Me a Coffee!](https://www.buymeacoffee.com/ahrm)
...
You can extend sioyek using external commands and scripts. For example you can add [OCR, translation, and text to speech](https://ahrm.github.io/jekyll/update/2022/07/05/implementing-a-screen-reader-for-sioyek.html) to sioyek.