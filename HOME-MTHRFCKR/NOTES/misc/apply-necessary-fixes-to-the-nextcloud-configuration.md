...
---
# _Apply necessary fixes to the Nextcloud configuration_
...
To save the file press CTRL + X then Y and **_enter_**.
...
Replace **_GB_** with [your country code](https://en.wikipedia.org/wiki/ISO_3166-1), e.g.: RO, DE, US.
...
-   Part 5: This article
-   **_Part 6:_** [**_Add an SMTP account to make your Nextcloud send emails_**](https://che-adrian.medium.com/add-an-smtp-account-to-make-your-nextcloud-send-emails-f636e6f34d8)
