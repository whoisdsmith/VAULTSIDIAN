...
Also, beware that stopwords and other text processing tools might “break” this factor, for exactly the same reasons that we disscussed a little earlier in [exact\_field\_hit](http://sphinxsearch.com/docs/sphinx3.html#exact_field_hit).
