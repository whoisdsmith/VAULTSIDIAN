...
You can create a data structure by clicking the _Create a new data structure_ button in the Data structure overview section or in the settings of the module that requires data structure specification.

Supported data types are described in the [Types of module](https://www.make.com/en/help/modules/types-of-modules.html "Types of modules") items section.
