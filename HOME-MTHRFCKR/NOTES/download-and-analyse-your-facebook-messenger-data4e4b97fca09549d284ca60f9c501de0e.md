...
- Select the data range “**All of my data**”, format “**JSON**” and Media Quality “**High**” *(Feel free to change the media quality as high media quality will consume more storage)*
- Select **Messages** only *(At this case, I am only interested at my message data, you may try on other data as well)*
...
`folders.remove(".DS_Store")` is used here to remove the system file in macOS. It is to prevent the error in the loop later. *(Windows user can ignore this)*
