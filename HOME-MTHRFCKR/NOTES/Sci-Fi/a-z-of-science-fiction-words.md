...
**D[[warf star]].** Main sequence stars of absolute magnitude greater than 1. Stars of low luminosity.
...
**[[../../osint/osint-bookmarks/work.md]].** Phenomenon whereby a force acts on a body in such a way that motion results. If a force F acts on a body and its point of application moves a distance s in a direction making an angle _theta_ with the direction of F, then the force is said to do an amount of work F_cos theta_ on the body.
