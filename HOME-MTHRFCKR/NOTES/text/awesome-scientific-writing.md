...
![:bookmark:](https://github.githubassets.com/images/icons/emoji/unicode/1f516.png) means ability to **seamlessly cite references**.

![:link:](https://github.githubassets.com/images/icons/emoji/unicode/1f517.png) means ability to **cross-reference figures and sections within the document**.
...
## Word Processors
  ...
  * [R Studio](https://github.com/rstudio/rstudio) \- IDE for R. 
    * [bookdown](https://github.com/rstudio/bookdown) \- R package to facilitate writing books and long-form articles, reports with R Markdown ![:bookmark:](https://github.githubassets.com/images/icons/emoji/unicode/1f516.png) ![:link:](https://github.githubassets.com/images/icons/emoji/unicode/1f517.png).
    * [R Markdown](https://rmarkdown.rstudio.com/) \- R package to write R next to Markdown ![:bookmark:](https://github.githubassets.com/images/icons/emoji/unicode/1f516.png) ![:link:](https://github.githubassets.com/images/icons/emoji/unicode/1f517.png).
  ...
  * [Zettlr](https://www.zettlr.com/) \- Markdown editor which integrates CSL, BibLaTeX, Pandoc and many other tools ![:bookmark:](https://github.githubassets.com/images/icons/emoji/unicode/1f516.png) ![:link:](https://github.githubassets.com/images/icons/emoji/unicode/1f517.png).
...
Supplementary files and tools.
  ...
  * [Cicero](https://cicero.xyz/) \- Python package which renders HTML presentations from Markdown source using remark or reveal.js ![:link:](https://github.githubassets.com/images/icons/emoji/unicode/1f517.png).
  * [docutils](https://docutils.sourceforge.io/docs/) \- Python package which can convert reStructuredText into various formats and provides command-line tools to do it ![:link:](https://github.githubassets.com/images/icons/emoji/unicode/1f517.png).
  ...
  * [nbconvert](https://nbconvert.readthedocs.io/en/latest/) \- Convert Jupyter notebooks into `reveal.js` presentations, PDF, HTML, Markdown, reStructuredText and more. 
    * [bookbook](https://github.com/takluyver/bookbook/#readme) \- Experimental Python package which extends `nbconvert` and adds the ability to cross reference within and across notebooks ![:link:](https://github.githubassets.com/images/icons/emoji/unicode/1f517.png).
    * [ipypublish](https://github.com/chrisjsewell/ipypublish/#readme) \- Workflow for creating and editing publication ready scientific reports and presentations, from one or more Jupyter Notebooks, without leaving the browser ![:bookmark:](https://github.githubassets.com/images/icons/emoji/unicode/1f516.png) ![:link:](https://github.githubassets.com/images/icons/emoji/unicode/1f517.png).
  * [pandoc](https://pandoc.org/MANUAL) \- Haskell library for converting from one markup format to another, and a command-line tool that uses this library ![:bookmark:](https://github.githubassets.com/images/icons/emoji/unicode/1f516.png) ![:link:](https://github.githubassets.com/images/icons/emoji/unicode/1f517.png). 
    * [Academic Markdown](https://github.com/smathot/academicmarkdown#readme) \- Python wrapper over Pandoc with specialized extensions to parse certain elements, making it a superset of Pandoc Markdown flavour ![:bookmark:](https://github.githubassets.com/images/icons/emoji/unicode/1f516.png) ![:link:](https://github.githubassets.com/images/icons/emoji/unicode/1f517.png).
...
Contributions welcome! Read the [contribution guidelines](/awesome-scientific-writing/CONTRIBUTING.md) first.
