...
![](troubleshooting/open-multiple-links/chrome.png)
...
![![](troubleshooting/open-multiple-links/firefox1.png)
...
<https://app.raindrop.io> to "Address of website" field, click "Allow" and "Save Changes"
