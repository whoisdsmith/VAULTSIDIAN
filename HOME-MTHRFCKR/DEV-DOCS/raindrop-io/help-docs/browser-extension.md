...
![](using/browser-extension/intro.jpg)
...
![](using/browser-extension/clipper.jpg)
...
![](using/browser-extension/mini_app.jpg)
...
[Learn more](HOME-MTHRFCKR/DEV-DOCS/raindrop-io/help-docs/highlights.md#add-extension)
...
![](using/browser-extension/omnibox.png)Just type ``rd`` and then your search query. For example `rd design`.

:::tip
Feel free to use [a[advanced search operators](HOME-MTHRFCKR/DEV-DOCS/raindrop-io/help-docs/search.md#operators)o find precisely
:::
