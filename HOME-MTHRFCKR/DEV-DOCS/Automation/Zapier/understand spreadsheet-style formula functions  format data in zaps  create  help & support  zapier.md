## [Formula Functions](https://zapier.com/help/create/format/understand-spreadsheet-style-formula-functions#step-1)
...
- **IF(condition, true\_value, \[false\_value\])**: Returns the true\_value if the condition is TRUE or false\_value if the condition is FALSE
...
## [Formula Arithmetic](https://zapier.com/help/create/format/understand-spreadsheet-style-formula-functions#step-2)
...
## [Formula Comparisons](https://zapier.com/help/create/format/understand-spreadsheet-style-formula-functions#step-3)
...
## [Formula Examples](https://zapier.com/help/create/format/understand-spreadsheet-style-formula-functions#step-4)
