---
created: 2022-07-16T02:19:28 (UTC -04:00)
tags: []
source: https://docs.rockylinux.org/guides/automation/cron_jobs_howto/
...
---
# Automating Processes with `cron` and `crontab`[¶](https://docs.rockylinux.org/guides/automation/cron_jobs_howto//#automating-processes-with-cron-and-crontab "Permanent link")

## Prerequisites[¶](https://docs.rockylinux.org/guides/automation/cron_jobs_howto//#prerequisites "Permanent link")

-   A machine running Rocky Linux
-   Some comfort with modifying configuration files from the command-line using your favorite editor (`vi` is used here)

## Assumptions[¶](https://docs.rockylinux.org/guides/automation/cron_jobs_howto//#assumptions "Permanent link")
...
## Introduction[¶](https://docs.rockylinux.org/guides/automation/cron_jobs_howto//#introduction "Permanent link")
...
#### For Servers[¶](https://docs.rockylinux.org/guides/automation/cron_jobs_howto//#for-servers "Permanent link")

As stated in the introduction, `cron` normally runs `anacron` these days to execute scripts in these "dot" directories. You _may_, though, want to use these "dot" directories on servers as well, and if that is the case, then there are two steps that you can take to make sure that these "dot" directories are run on a strict schedule. To do so, we need to install a package and remove another one:
...
#### For Workstations[¶](https://docs.rockylinux.org/guides/automation/cron_jobs_howto//#for-workstations "Permanent link")
...
### Create Your Own `cron`[¶](https://docs.rockylinux.org/guides/automation/cron_jobs_howto//#create-your-own-cron "Permanent link")

Of course, if the automated, randomized times don't work well in [For Workstations above](https://docs.rockylinux.org/guides/automation/cron_jobs_howto//#for-workstations), and the scheduled times in the [For Servers above](https://docs.rockylinux.org/guides/automation/cron_jobs_howto//#for-servers), then you can create your own. In this example, we are assuming you are doing this as root. [see Assumptions](https://docs.rockylinux.org/guides/automation/cron_jobs_howto//#assumptions) To do this, type the following:
...
### The @options for `crontab`[¶](https://docs.rockylinux.org/guides/automation/cron_jobs_howto//#the-options-for-crontab "Permanent link")
...
### More Complex Options[¶](https://docs.rockylinux.org/guides/automation/cron_jobs_howto//#more-complex-options "Permanent link")
...
## Conclusions[¶](https://docs.rockylinux.org/guides/automation/cron_jobs_howto//#conclusions "Permanent link")
...
-   For machines that are **not** on 24 hours a day, explore [anacron - Automating commands](https://docs.rockylinux.org/guides/automation/cron_jobs_howto//../anacron/).
-   For a concise description of `cron` processes, check out [cronie - Timed Tasks](https://docs.rockylinux.org/guides/automation/cron_jobs_howto//../cronie/)
