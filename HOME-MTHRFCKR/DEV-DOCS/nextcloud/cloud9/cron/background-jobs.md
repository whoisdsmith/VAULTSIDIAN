---
tags:: cron
created: 2022-07-16T00:14:01 (UTC -04:00)
tags: []
source: https://docs.nextcloud.com/server/24/admin_manual/configuration_server/background_jobs_configuration.html
author: 
---
...
These jobs are typically referred to as _cron jobs_. Cron jobs are commands or shell-based scripts that are scheduled to run periodically at fixed times, dates, or intervals. `cron.php` is a Nextcloud internal process that runs such background jobs on demand.
...
## Parameters[](https://docs.nextcloud.com/server/24/admin_manual/configuration_server/background_jobs_configuration.html#parameters "Permalink to this heading")

### `maintenance_window_start`[](https://docs.nextcloud.com/server/24/admin_manual/configuration_server/background_jobs_configuration.html#maintenance-window-start "Permalink to this heading")
...
## Cron jobs[](https://docs.nextcloud.com/server/24/admin_manual/configuration_server/background_jobs_configuration.html#cron-jobs "Permalink to this heading")
...
### AJAX[](https://docs.nextcloud.com/server/24/admin_manual/configuration_server/background_jobs_configuration.html#ajax "Permalink to this heading")
...
### Webcron[](https://docs.nextcloud.com/server/24/admin_manual/configuration_server/background_jobs_configuration.html#webcron "Permalink to this heading")

**Usecase: Very small instance** (1-5 users depending on the usage)

By registering your Nextcloud `cron.php` script address at an external webcron service (for example, [easyCron](https://www.easycron.com/)), you ensure that background jobs are executed regularly. To use this type of service with your server, you must be able to access your server using the Internet. For example:
...
### Cron[](https://docs.nextcloud.com/server/24/admin_manual/configuration_server/background_jobs_configuration.html#cron "Permalink to this heading")
...
For some configurations, it might be neccessary to append `--define apc.enable_cli=1` to the cron command. Please refer to [Memory caching](https://docs.nextcloud.com/server/24/admin_manual/configuration_server/caching_configuration.html) (section APCu).

Note

Please refer to the crontab man page for the exact command syntax.

### systemd[](https://docs.nextcloud.com/server/24/admin_manual/configuration_server/background_jobs_configuration.html#systemd "Permalink to this heading")
