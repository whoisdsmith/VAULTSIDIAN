---
created: 2022-08-05T00:36:36 (UTC -04:00)
tags: []
source: https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap
author: 
---
...
---
# Using the occ command[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#using-the-occ-command "Permalink to this heading")
...
## occ command Directory[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#occ-command-directory "Permalink to this heading")

-   [Run occ as your HTTP user](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#http-user-label)
    
-   [Apps commands](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#apps-commands-label)
    
-   [Background jobs selector](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#background-jobs-selector-label)
    
-   [Config commands](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#config-commands-label)
    
-   [Dav commands](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#dav-label)
    
-   [Database conversion](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#database-conversion-label)
    
-   [Add missing indices](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#database-add-indices-label)
    
-   [Encryption](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#encryption-label)
    
-   [Federation sync](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#federation-sync-label)
    
-   [File operations](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#file-operations-label)
    
-   [Files external](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#files-external-label)
    
-   [Integrity check](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#integrity-check-label)
    
-   [l10n, create JavaScript translation files for apps](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#create-javascript-translation-files-label)
    
-   [LDAP commands](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#ldap-commands-label)
    
-   [Logging commands](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#logging-commands-label)
    
-   [Maintenance commands](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#maintenance-commands-label)
    
-   [Security](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#security-commands-label)
    
-   [Trashbin](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#trashbin-label)
    
-   [User commands](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#user-commands-label)
    
-   [Group commands](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#group-commands-label)
    
-   [Versions](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#versions-label)
    
-   [Command line installation](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#command-line-installation-label)
    
-   [Command line upgrade](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#command-line-upgrade-label)
    
-   [Two-factor authentication](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#two-factor-auth-label)
    
-   [Disable users](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#disable-user-label)
    
-   [Debugging](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#debugging)
    

## Run occ as your HTTP user[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#run-occ-as-your-http-user "Permalink to this heading")
...
## Enabling autocompletion[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#enabling-autocompletion "Permalink to this heading")
...
## Apps commands[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#apps-commands "Permalink to this heading")
...
## Background jobs selector[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#background-jobs-selector "Permalink to this heading")
...
See [Background jobs](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldapbackground_jobs_configuration.html) to learn more.

## Config commands[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#config-commands "Permalink to this heading")
...
### Getting a single configuration value[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#getting-a-single-configuration-value "Permalink to this heading")
...
### Setting a single configuration value[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#setting-a-single-configuration-value "Permalink to this heading")
...
### Setting an array configuration value[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#setting-an-array-configuration-value "Permalink to this heading")
...
### Setting a hierarchical configuration value[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#setting-a-hierarchical-configuration-value "Permalink to this heading")
...
### Deleting a single configuration value[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#deleting-a-single-configuration-value "Permalink to this heading")
...
## Dav commands[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#dav-commands "Permalink to this heading")
...
See [Calendar / CalDAV](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap../groupware/calendar.html) for more information on how to use this command.
...
## Database conversion[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#database-conversion "Permalink to this heading")
...
For a more detailed explanation see [Converting database type](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap../configuration_database/db_conversion.html)

## Add missing indices[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#add-missing-indices "Permalink to this heading")
...
## Encryption[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#encryption "Permalink to this heading")
...
`encryption:encrypt-all` encrypts all data files for all users. You must first put your Nextcloud server into [maintenance mode](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#maintenance-commands-label) to prevent any user activity until encryption is completed.
...
Use `encryption:disable` to disable your encryption module. You must first put your Nextcloud server into [maintenance mode](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#maintenance-commands-label) to prevent any user activity.
...
See [Encryption configuration](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap../configuration_files/encryption_configuration.html) to learn more.

## Federation sync[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#federation-sync "Permalink to this heading")
...
## File operations[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#file-operations "Permalink to this heading")
...
### Scan[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#scan "Permalink to this heading")
...
In the example above, the user\_id `alice` is determined implicitly from the path component given.

The `--path`, `--all` and `[user_id]` parameters are exclusive - only one must be specified.

### Scan appdata[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#scan-appdata "Permalink to this heading")
...
### Cleanup[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#cleanup "Permalink to this heading")
...
### Transfer[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#transfer "Permalink to this heading")
...
Users may also transfer files or folders selectively by themselves. See [user documentation](https://docs.nextcloud.com/server/latest/user_manual/en/files/transfer_ownership.html) for details.

## Files Sharing[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#files-sharing "Permalink to this heading")
...
## Files external[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#files-external "Permalink to this heading")
...
## Integrity check[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#integrity-check "Permalink to this heading")
...
When it returns nothing, your app is signed correctly. When it returns a message then there is an error. See [Code Signing](https://docs.nextcloud.com/server/latest/developer_manual/app_publishing_maintenance/code_signing.html#how-to-get-your-app-signed) in the Developer manual for more detailed information.

`integrity:sign-core` is for Nextcloud core developers only.

See [Code signing](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap../issues/code_signing.html) to learn more.

## l10n, create JavaScript translation files for apps[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#l10n-create-javascript-translation-files-for-apps "Permalink to this heading")

This command is for app developers to update their translation mechanism from ownCloud 7 to Nextcloud.

## LDAP commands[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#ldap-commands "Permalink to this heading")
...
`ldap:show-remnants` is for cleaning up the LDAP mappings table, and is documented in [LDAP user cleanup](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap../configuration_user/user_auth_ldap_cleanup.html).

## Logging commands[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#logging-commands "Permalink to this heading")
...
-   `--timezone` according to [https://www.php.net/manual/en/timezones.php](https://www.php.net/manual/en/timezones.php)
    

## Maintenance commands[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#maintenance-commands "Permalink to this heading")
...
## Security[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#security "Permalink to this heading")
...
## Trashbin[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#trashbin "Permalink to this heading")
...
## User commands[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#user-commands "Permalink to this heading")
...
You can reset any user’s password, including administrators (see [Resetting a lost admin password](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap../configuration_user/reset_admin_password.html)):
...
## Group commands[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#group-commands "Permalink to this heading")
...
`output` specifies the output format (plain, json or json\_pretty). Default is plain.

## Versions[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#versions "Permalink to this heading")
...
## Command line installation[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#command-line-installation "Permalink to this heading")
...
## Command line upgrade[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#command-line-upgrade "Permalink to this heading")
...
## Two-factor authentication[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#two-factor-authentication "Permalink to this heading")
...
## Disable users[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#disable-users "Permalink to this heading")
...
## Debugging[](https://docs.nextcloud.com/server/stable/admin_manual/configuration_server/occ_command.html?highlight=ldap#debugging "Permalink to this heading")
