---
created: 2022-08-05T00:25:44 (UTC -04:00)
tags: []
source: http://versonatura.org/cloud/core/doc/admin/configuration_server/occ_command.html
author: 
---

# Using the occ Command — ownCloud Server Administration Manual 8.1 documentation
...
## Run occ As Your HTTP User[¶](http://versonatura.org/cloud/core/doc/admin/configuration_server/occ_command.html#run-occ-as-your-http-user "Permalink to this headline")

The HTTP user is different on the various Linux distributions. See [_Setting Strong Directory Permissions_](http://versonatura.org/cloud/core/doc/admin/installation/installation_wizard.html#strong-perms) to learn how to find your HTTP user
...
## Apps Commands[¶](http://versonatura.org/cloud/core/doc/admin/configuration_server/occ_command.html#apps-commands "Permalink to this headline")
...
app:check-code checks if the app uses ownCloud’s public API (OCP) or private API (OC\_). If the app uses the private API it will print a warning:
...
## Background Jobs Selector[¶](http://versonatura.org/cloud/core/doc/admin/configuration_server/occ_command.html#background-jobs-selector "Permalink to this headline")
...
See [_Defining Background Jobs_](http://versonatura.org/cloud/core/doc/admin/configuration_server/background_jobs_configuration.html) to learn more.

## Database Conversion[¶](http://versonatura.org/cloud/core/doc/admin/configuration_server/occ_command.html#database-conversion "Permalink to this headline")
...
For a more detailed explanation see [_Converting Database Type_](http://versonatura.org/cloud/core/doc/admin/configuration_database/db_conversion.html)

## Encryption[¶](http://versonatura.org/cloud/core/doc/admin/configuration_server/occ_command.html#encryption "Permalink to this headline")
...
## File Operations[¶](http://versonatura.org/cloud/core/doc/admin/configuration_server/occ_command.html#file-operations "Permalink to this headline")
...
## Command Line Installation[¶](http://versonatura.org/cloud/core/doc/admin/configuration_server/occ_command.html#command-line-installation "Permalink to this headline")

You can install ownCloud entirely from the command line. After downloading the tarball and copying ownCloud into the appropriate directories, or after installing ownCloud packages (See [_Preferred Linux Installation Method_](http://versonatura.org/cloud/core/doc/admin/installation/linux_installation.html) and [_Manual Installation on Linux_](http://versonatura.org/cloud/core/doc/admin/installation/source_installation.html)) you can use occ commands in place of running the graphical Installation Wizard.

Apply correct permissions to your ownCloud directories; see [_Setting Strong Directory Permissions_](http://versonatura.org/cloud/core/doc/admin/installation/installation_wizard.html#strong-perms). Then choose your occ options. This lists your available options:
...
## l10n, Create javascript Translation Files for Apps[¶](http://versonatura.org/cloud/core/doc/admin/configuration_server/occ_command.html#l10n-create-javascript-translation-files-for-apps "Permalink to this headline")
...
These are the supported language codes, and [Codes for the Representation of Names of Languages](http://www.loc.gov/standards/iso639-2/php/code_list.php) may be helpful:
...
## LDAP Commands[¶](http://versonatura.org/cloud/core/doc/admin/configuration_server/occ_command.html#ldap-commands "Permalink to this headline")
...
ldap:show-remnants is for cleaning up the LDAP mappings table, and is documented in [_LDAP User Cleanup_](http://versonatura.org/cloud/core/doc/admin/configuration_user/user_auth_ldap_cleanup.html).

## Maintenance Commands[¶](http://versonatura.org/cloud/core/doc/admin/configuration_server/occ_command.html#maintenance-commands "Permalink to this headline")
...
## User Commands[¶](http://versonatura.org/cloud/core/doc/admin/configuration_server/occ_command.html#user-commands "Permalink to this headline")
...
You can reset any user’s password, including administrators (see [_Resetting a Lost Admin Password_](http://versonatura.org/cloud/core/doc/admin/configuration_user/reset_admin_password.html)):
...
## Upgrade Command[¶](http://versonatura.org/cloud/core/doc/admin/configuration_server/occ_command.html#upgrade-command "Permalink to this headline")
