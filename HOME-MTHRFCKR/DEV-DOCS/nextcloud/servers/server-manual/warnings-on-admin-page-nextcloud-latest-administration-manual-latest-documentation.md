...
tags:: documents
---
# Warnings on admin page — Nextcloud latest Administration Manual latest documentation
...
![../_images/security-setup-warning-1.png](../_images/security-setup-warning-1.png)

You can use the [Nextcloud Security Scan](https://scan.nextcloud.com) to see if your system is up to date and well secured. We have ran this scan over public IP addresses in the past to try and reach out to [extremely outdated systems](https://nextcloud.com/blog/nextcloud-releases-security-scanner-to-help-protect-private-clouds/) and might again in the future. Please, protect your privacy and keep your server up to date! Privacy means little without security.
...
If you see “_{Cache}_ below version _{Version}_ is installed. for stability and performance reasons we recommend to update to a newer _{Cache}_ version” then you need to upgrade, or, if you’re not using it, remove it.

You are not required to use any caches, but caches improve server performance. See [Memory caching](caching_configuration.html).
...
Please see [Transactional file locking](../configuration_files/files_locking_transactional.html) on how to correctly configure your environment for transactional file locking.
...
[Enabling SSL](../installation/source_installation.html#enabling-ssl-label) (on Apache)

[Use HTTPS](../installation/harden_server.html#use-https-label)

[NGINX configuration](../installation/nginx.html)

## The test with getenv("PATH") only returns an empty response

Some environments are not passing a valid PATH variable to Nextcloud. The [php-fpm configuration notes](../installation/source_installation.html#php-fpm-tips-label) provides the information about how to configure your environment.
...
The HSTS header needs to be configured within your Web server by following the [Enable HTTP Strict Transport Security](../installation/harden_server.html#enable-hsts-label) documentation
...
This message is another one which needs to be taken seriously. Please have a look at the [Give PHP read access to /dev/urandom](../installation/harden_server.html#dev-urandom-label) documentation.
...
At the ownCloud community forums a larger [FAQ](https://forum.owncloud.org/viewtopic.php?f=17&t=7536) is maintained containing various information and debugging hints.
...
Please refer to [Database “READ COMMITTED” transaction isolation level](../configuration_database/linux_database_configuration.html#db-transaction-label) how to configure your database for this requirement.
