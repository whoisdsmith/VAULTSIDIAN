...
tags:: documents
---
# Mimetypes management — Nextcloud latest Administration Manual latest documentation
...
Once you have made changes to your `mimetypealiases.json`, use the `occ` command to propagate the changes through the system. This example is for Ubuntu Linux:
    ...
    See [Using the occ command](../configuration_server/occ_command.html) to learn more about occ.
