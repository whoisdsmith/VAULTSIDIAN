...
APIs are coded in Javascript and are very easy to make! Check out the [documentation](documentation) or follow our API walkthrough to learn how to start making your own APIs!  
...
[> Calling your APIs](documentation#callingAPIs)
...
[> About Snippets](documentation#snippets)