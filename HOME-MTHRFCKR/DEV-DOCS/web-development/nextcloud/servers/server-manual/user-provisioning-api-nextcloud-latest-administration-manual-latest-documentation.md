...
tags:: documents
---
# User provisioning API — Nextcloud latest Administration Manual latest documentation
...
All POST requests require the `Content-Type: application/x-www-form-urlencoded` header. (Note: Some libraries like cURL set this header automatically, others require setting the header explicitly.)
  ...
  * [Instruction set for users](instruction_set_for_users.html)
  * [Instruction set for groups](instruction_set_for_groups.html)
  * [Instruction set for apps](instruction_set_for_apps.html)
