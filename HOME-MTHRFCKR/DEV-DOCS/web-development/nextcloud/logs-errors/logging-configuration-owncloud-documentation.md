---
tags:: logs
created: 2022-07-16T20:59:51 (UTC -04:00)
tags: []
source: https://doc.owncloud.com/server/next/admin_manual/configuration/server/logging/logging_configuration.html
author: 
---

# Logging Configuration :: ownCloud Documentation
...
-   [Introduction](https://doc.owncloud.com/server/next/admin_manual/configuration/server/logging/logging_configuration.html#introduction)
-   [Parameters](https://doc.owncloud.com/server/next/admin_manual/configuration/server/logging/logging_configuration.html#parameters)
    -   [ownCloud](https://doc.owncloud.com/server/next/admin_manual/configuration/server/logging/logging_configuration.html#owncloud)
    -   [syslog](https://doc.owncloud.com/server/next/admin_manual/configuration/server/logging/logging_configuration.html#syslog)
    -   [Conditional Logging Level Increase](https://doc.owncloud.com/server/next/admin_manual/configuration/server/logging/logging_configuration.html#conditional-logging-level-increase)

## [](https://doc.owncloud.com/server/next/admin_manual/configuration/server/logging/logging_configuration.html#introduction)Introduction
...
## [](https://doc.owncloud.com/server/next/admin_manual/configuration/server/logging/logging_configuration.html#parameters)Parameters
...
### [](https://doc.owncloud.com/server/next/admin_manual/configuration/server/logging/logging_configuration.html#owncloud)ownCloud
...
The desired date format can optionally be defined using the **logdateformat** parameter in config/config.php. By default the [PHP date function](https://www.php.net/manual/en/function.date.php) parameter `_c_` is used, and therefore the date/time is written in the format `_2013-01-10T15:20:25+02:00_`. By using the date format in the example below, the date/time format will be written in the format `_January 10, 2013 15:20:25_`.
...
### [](https://doc.owncloud.com/server/next/admin_manual/configuration/server/logging/logging_configuration.html#syslog)syslog
...
### [](https://doc.owncloud.com/server/next/admin_manual/configuration/server/logging/logging_configuration.html#conditional-logging-level-increase)Conditional Logging Level Increase
