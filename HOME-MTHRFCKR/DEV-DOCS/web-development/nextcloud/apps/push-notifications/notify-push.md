...
tags:: apps
---
# nextcloud/notify_push: Update notifications for nextcloud clients
...
For OpenRC based setups, you can create a OpenRC service by creating a file named `/etc/init.d/notify_push` with the following content.
...
#### Caddy v2
    ...
    For information about how to use the push server in your own app or client, see [DEVELOPING.md](/nextcloud/notify_push/blob/main/DEVELOPING.md)
