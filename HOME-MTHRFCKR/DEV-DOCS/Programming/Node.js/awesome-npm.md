...
_Please read the [contribution guidelines](https://github.com/sindresorhus/awesome-npm/blob/main/contributing.md) before contributing._

## Contents

-   [Articles](https://github.com/sindresorhus/awesome-npm#articles)
-   [Tools](https://github.com/sindresorhus/awesome-npm#tools)
-   [Packages](https://github.com/sindresorhus/awesome-npm#packages)
-   [Clients](https://github.com/sindresorhus/awesome-npm#clients)
-   [Tips](https://github.com/sindresorhus/awesome-npm#tips)
-   [FAQ](https://github.com/sindresorhus/awesome-npm#faq)
-   [Community](https://github.com/sindresorhus/awesome-npm#community)
-   [Documentation](https://github.com/sindresorhus/awesome-npm#documentation)
-   [Support](https://github.com/sindresorhus/awesome-npm#support)
-   [Related](https://github.com/sindresorhus/awesome-npm#related)
...
alias nr='npm run'
alias ns='npm start'
alias nf='npm cache clean && rm -rf node\_modules && npm install'
