...
> *![⚠️](https://s.w.org/images/core/emoji/14.0.0/svg/26a0.svg)* **_Disclaimer on Operating Systems  
...
> *![💡](https://s.w.org/images/core/emoji/14.0.0/svg/1f4a1.svg)* In the screenshot above you can see shorthands using the `@something` notation. On the systems allowing these, they replace the whole expression.
...
> *![💡](https://s.w.org/images/core/emoji/14.0.0/svg/1f4a1.svg)* Just in case we will add the execution permission for my user to the script. Even though testing showed that it is not necessary, it felt like the right thing to do.`chmod u+x delete-screenshots-older-30-days.sh`did the trick just fine.
