...
| ----------------------------------------[[Linking Content#Details]]Linking Content#Details]]------------- |  
| Link to an entire note | `[[name of the note][[Linking Content#^0266aa]]ent](../../../../../..//Templates/Template%20Hub/Templates/Obsidian-Vault-Structure/03%20-%20Content/Linking%20Content.md) |  
| Link to a n[[Linking Content#^0834a4]] |`[[name of the note#heading]]`| [[Linking Content#Details]] |
| Link to a block within a specified heading | `[[name [[Linking Content#^0266aa]]Linking Content#^0266aa]] |

1. At each stage of linking, the relevant content can instead be embedded by adding the *!* prefix ^0834a4
 1. Examp[[Linking Content#^0834a4]]Linking Content#^0834a4]]
 ...
 ![[Pasted image 20210907120723.png](Template%20Hub/Templates/Obsidian-Vault-Structure/03%20-%20Content/files/Pasted%20image%2020210907120723.png)
...
![[Pasted image 20210907120756.png](Template%20Hub/Templates/Obsidian-Vault-Structure/03%20-%20Content/files/Pasted%20image%2020210907120756.png)  
...
![[Pasted image 20210907120838.png](Template%20Hub/Templates/Obsidian-Vault-Structure/03%20-%20Content/files/Pasted%20image%2020210907120838.png)

### After

![[Pasted image 20210907121102.png](Template%20Hub/Templates/Obsidian-Vault-Structure/03%20-%20Content/files/Pasted%20image%2020210907121102.png)

1. "Unlinked Mentions" as these unlinked notes are refered to, can then be created simply by clicking the identified unlinked *link* or *node*
2. If you're using templates when creating new notes, the hierarchical folder structure above your new note is automatically applied to the note a series of links. Unlike [[Tagging Content|Tags]], several *links* should be added to new notes with the idea that more meaningful links creates more relationships/opportunity for relationships between notes. This process should ultimately lead to a natural distillation of categorical knowledge and thus a new category and MOC.
