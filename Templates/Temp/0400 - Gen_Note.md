...
async function getNoteStruct(noteTag) {  
	...
	if (tag.startsWith('📕')) {
		structName = "[[0403 - Struct_TTP_Body](0403%20-%20Struct_TTP_Body.md)";
		dest = "03 - Content";
		prefix = "";
	} else if (tag.startsWith('🧰')) {
		structName = "[[0404 - Struct_Tool_Body](0404%20-%20Struct_Tool_Body.md)";
		dest = "03 - Content";
		prefix = "";
	} else if (tag.startsWith('💡')) {
		structName = "[[0405 - Struct_Idea_Body](0405%20-%20Struct_Idea_Body.md)";
		dest = "03 - Content";
		prefix = "";
	} else if (tag.startsWith('📖')) {
		structName = "[[0406 - Struct_Documentation_Body](0406%20-%20Struct_Documentation_Body.md)";
		dest = "03 - Content";
		prefix = "";
	} else if (tag.startsWith('🗺')) {
		structName = "[[0409 - Struct_Secondary_Category_Body](0409%20-%20Struct_Secondary_Category_Body.md)";
		dest = "02 - Secondary Categories";
		prefix = "02 - ";
	} else if (tag.startsWith('㊙️')) {
		structName = "[[0407 - Struct_Personal_Body](0407%20-%20Struct_Personal_Body.md)";
		dest = "05 - Personal";
		prefix = "";
	} else {
