...
![[Pasted image 20210907125248.png](Template%20Hub/Templates/Obsidian-Vault-Structure/03%20-%20Content/files/Pasted%20image%2020210907125248.png)

1. Within the newly created `snippets` folder, create a single `.css` or several `.css` files with the descired snippets below.

![[Pasted image 20210907125653.png](Template%20Hub/Templates/Obsidian-Vault-Structure/03%20-%20Content/files/Pasted%20image%2020210907125653.png)

1. After the files are present within the file structure, again path to `Settings > Appearences` and click the `refresh` icon next to the folder icon we chose previously. All individual `.css` files should now be listed as toggle-able style options.
...
While Obsidian exposes the ability to colorize the graph view using groups, there doesnt seem to yet be a way to colorize un![[Linking Content#Before]][![[Linking Content#After]][[Linking Content#After]]ple  
...
![[Pasted image 20210907122512.png](Template%20Hub/Templates/Obsidian-Vault-Structure/03%20-%20Content/files/Pasted%20image%2020210907122512.png)
...
![[Template%20Hub/Templates/Obsidian-Vault-Structure/03%20-%20Content/files/highlight_currentline.gif]]
...
![[highlight_currentline 1.gif](Template%20Hub/Templates/Obsidian-Vault-Structure/03%20-%20Content/files/highlight_currentline%201.gif)
...
![[Pasted image 20210907124937.png](Template%20Hub/Templates/Obsidian-Vault-Structure/03%20-%20Content/files/Pasted%20image%2020210907124937.png)
...
![[Template%20Hub/Templates/Obsidian-Vault-Structure/03%20-%20Content/files/responsive_yt.gif]]
